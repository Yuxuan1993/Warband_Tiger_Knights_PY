...
##     ),
 ...
 #add by dark night
  ("beat_zhangjiao", "Beat Zhangjiao", 0,
  "{!}placeholder."
  ),   
  
  ("ask_merchant", "Ask merchant", 0,
  "{!}placeholder."
  ),   
  
  ("ask_shuijing", "Ask shuijing", 0,
  "{!}placeholder."
  ),   
  
  ("duel_chuyun", "Duel Chu Yun", 0,
  "{!}Duel Chu Yun."
  ), 
  
  ("find_stone", "Duel Chu Yun", 0,
  "{!}placeholder."
  ), 
 ...
 #add by darknight test
  ("portect_yuji", "protect Yu Ji", 0,
  "{!}placeholder."
  ), 
 #add end
]
