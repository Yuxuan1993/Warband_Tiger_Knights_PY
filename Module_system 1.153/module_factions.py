...
#  ("vaegir_caravans","Vaegir Caravans", 0, 0.5,[("outlaws",-0.8), ("dark_knights",-0.2)], []),
  ...
  ("kingdom_6",  "Dongzhuo",  0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0xff8a00),
  
  ("kingdom_7",  "Gongsunzan", 0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0xe1b8b1),
  ("kingdom_8",  "Kongrong", 0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0x54cbad),
  ("kingdom_9",  "Liuyan",  0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0x8400ff),
  ("kingdom_10",  "Mateng",  0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0xae7f0e),
  ("kingdom_11",  "Taoqian",  0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0xce12d5),
  ("kingdom_12",  "Yuanshu",  0, 0.9, [("neutral_new",-0.02),("outlaws",-0.02),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.02),("forest_bandits", -0.02)], [], 0x93b1aa),
