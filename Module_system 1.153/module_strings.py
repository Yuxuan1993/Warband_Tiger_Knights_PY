...
#multiplayer game type names
 ...
 ## ZZ juewei 
 ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is a vassal of {s55} of {s56}.^}}Renown: {reg5}. Controversy: {reg15}.^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s59}^{s49}.^{s43}: {s44}.^{reg3?She:He}{reg10?subordinates:{s30}.:have no subordinates."),
#############################
...
## ZZ juewei
  ("renown_reg2_honour_rating_reg3s12_friends_s8_enemies_s6_s9", "Renown: {reg2}.^Honour rating: {reg3}.{s12}^Friends: {s8}.^Enemies: {s6}.^{s9}^your title is {s44}"),
###############  
...
############ TU ##### renwu #######
  ("bandit_hideout_preattack_2", "You approach the hideout. The {s4} don't appear to have spotted you yet, and you could still sneak away unnoticed. The difficult approach to the site -- {s5} -- means that only a handful of troops in your party will be able to join the attack, and they will be unable to bring their horses. If your initial attack fails, the {s4} will easily be able to make their escape and disperse. Do you wish to attack the hideout, or wait for another occasion?"),
###########################
  ...
  ("start_up_quest_message_4", "kill Zhangjiao."),
  ("start_up_quest_message_5", "ask merchant for the baoshi."),
  ("start_up_quest_message_6", "ask shuijing for the baoshi."),
  ("start_up_quest_message_7", "duel with Chu Yun."),
  ("start_up_quest_message_8", "find four stone and their masters."),
...
#juewei
## dantiao
  ("duel_in_war", "{s1}: Do you want duel with me?"),
  ("duel_in_war_begin", "duel begin !"),
  ("duel_in_war_will_begin", "dnel will begin after 15 seconds !"),
  ("want_duel_in_war", "Do you want to duel?"),
  ("agent_accept_duel_in_war", "Agent accept duel"),
  ("wait_duel_begin", "wait error !"),
  ("enter_duel_zone", "you have {reg0} second"),
  ("agent_refuse_duel_in_war", "Agent refuse duel"),
  ("lose_renown", "{s1} lose {reg1} renown"),
  ("get_renown", "{s1} get {reg1} renown"),
  ("give_up_duel", "you have give up the duel"),
  ("refused_duel", "each other refused to duel"),
  ("leave_duel_zone", "you have {reg0} second"),
  ("ai_duel", "Duel begin"),
  ("who_to_duel", "{s61} to duel"),
## dantiao

  # add by dark night start
  ("duel_starts_answer", "A duel, that sounds like an interesting idea. We could keep score and see who is the better fighter!"),
  ("duel_losses_answer", "Ah, so you wish to be beaten by me again, eh? I shall teach you another lesson in the art of dueling"),
  ("duel_wins_answer", "You may have won more of our duels than I, but that will change today!"),
  ("duel_same_answer", "We seem to be evenly match so another duel should prove to be interesting."),
  ("duel_way_answer", "I accept your challenge.^Do you wish to fight on horseback or on foot?"),
  ("duel_weapons_answer", "I accept your challenge. ^Let us choose our weapons."),
  ("last_duel_lost", "You lost your duel against ^^{s3}"),
  ("last_duel_win", "You won your duel against ^^{s3}"),
  ("last_duel_no", "You prepare to duel ^^{s3}"),
  ("duel_with_hero", "^^^^You have fought {s3} {reg5} times. ^^You've won {reg6} times. ^^You've lost {reg7} times"),
  ("duel_with_troop", "^^^^Dueling with your own troops will not count towards your dueling statistics."),
###### shijian ####### string #### TU ########
	("shijian_chuping","chuping"),#han
	("shijian_xingping","xingping"),
	("shijian_jianan","jianan"),
	("shijian_yankang","yankang"),
	
	("shijian_huangchu","huangchu"),#wei
	("shijian_taihe","taihe"),
	("shijian_qinglong","qinglong"),
	("shijian_jingchu","jingchu"),
	("shijian_zhengshi","zhengshi"),
	("shijian_jiaping","jiaping"),
	("shijian_zhengyuan","zhengyuan"),
	("shijian_ganlu_wei","ganlu"),
	("shijian_jingyuan","jingyuan"),
	("shijian_xianxi","xianxi"),
	
	("shijian_zhangwu","zhangwu"),#shu
	("shijian_jianxing_shu","jianxing"),
	("shijian_yanxi","yanxi"),
	("shijian_jingyao","jingyao"),
	("shijian_yanxing","yanxing"),
	
	("shijian_huangwu","huangwu"),#wu
	("shijian_huanglong","huanglong"),
	("shijian_jiahe","jiahe"),
	("shijian_chiwu","chiwu"),
	("shijian_taiyuan","taiyuan"),
	("shijian_shenfeng","shenfeng"),
	("shijian_jianxing_wu","jianxing"),
	("shijian_wufeng","wufeng"),
	("shijian_taiping","taiping"),
	("shijian_yongan","yongan"),
	("shijian_yuanxing","yongan"),
	("shijian_ganlu_wu","ganlu"),
	("shijian_baoding","baoding"),
	("shijian_jianheng","jianheng"),
	("shijian_fenghuang","fenghuang"),
	("shijian_tiance","tiance"),
	("shijian_tianxi","tianxi"),
	("shijian_tianji","tianji"),
	...
	("shijian_10"," "),
	############ TU ##### 7.4 #######
	("shijian_add_day","{s50}day"),
	("shijian_num_lianjie","{s51}{s52}{s53}"),
	("shijian_lianjie","{s56}{s57}year {s58}month {s59}"),
	###################
	("shijian_yuan","1"),
	("shijian_zhengyue","1"),
	("shijian_day_in_10","{s60}"),
###################
	("the_coach","The coach:{s10}"),
	("done","Done"),
	("go_back","Go back"),
	("you_lose_1_4_troops","you lose 1/4 troops"),
	("you_lose_1_renown","you lose 1 renown"),
	("he_lose_1_4_troops","he lose 1/4 troops"),
	("he_lose_1_renown","he lose 1 renown"),
	
####### string ########### gongzi ###### TU #######
	("your_wages","Your wages"),
##############

############# TU ###### string ######## zhanshou #########
	("s54_is_dead","{s54} is dead"),
############################
#add by dark night
("start_up_quest_message_9", "protect Mr Yu."),
#add end
...
################# TU ###### string ### mod_1 #####
	...
	("mod1_hulaoguan_menu"," "),
	("mod1_hulaoguan_menu_2"," "),
	("somebody_born","{s1} join {s2}."),
	
	("you_have_been_promoted_as_a", "You have been promoted as a {s44}."),
	("you_be_demoted_as_a", "You be demoted as a {s44}."),
	("you_have_been_promoted_as_a_juewei", "You have been promoted as a {s44}."),
	("you_be_demoted_as_a_juewei", "You be demoted as a {s44}."),
	("move_to_s46", "Move to {s47}."),
	("xianling", "County magistrate"),
	("taishou", "nomarch"),
	("jiangjun", "general"),
	
	("s40_listened_to_your_advice", "{s40} listened to your advice"),
	("s40_have_not_listened_to_your_advice", "{s40} have not listened to your advice"),
	("s40_have_more_important_things_to_do", "{s40} have not listened to your advice"),
###################

############### TU ###### suijishijian #### 7.11 ###
	("suijishijian_qiangdao_fail", "You failed"),
	("suijishijian_qiangdao_win", "Your victory"),
	("suijishijian_cike_fail", "You failed"),
	("suijishijian_cike_win", "Your victory"),
	("neizheng_details", "Companions num:{reg1}^Town prosperity:{reg2}^Town defense:{reg3}"),
###############
	("sry_you_cant", "sorry, you can`t do it"),
	("jineng_s1_use_s2_to_s3", "{s1} use {s2} for {s3}"),
	("you_s1_finish", "you {s1} have finished"),
	("jineng_s1_use_s2", "{s1} use {s2}"),
	
	
	("key1", " "),
	("key2", " "),
	("key3", " "),
	("yiyidailao", "yiyidailao"),
	("key5", " "),
	("key6", " "),
	...
	("meirenji", "meirenji"),
	("kongchengji", "kongchengji"),
	("key33", " "),
	("key34", " "),
	("key35", " "),
	("zouweishang", "zouweishang"),
	
	("weishe", "weishe"),
	("paoxiao", "paoxiao"),
	("kuaidao", "kuaidao"),
	("longdan", "longdan"),
	("jineng_s2_trigger", "{s2} trigger"),
##############
	("jincheng_battle", "jincheng pointer arrow"),
	
	("victory_chongche", "Victory!"),
	("victory_chengqiang", "Victory!"),
	("cheng_duel_begin", "Button W"),
	("refuse_duel", "Refuse duel"),
	("accept_duel_s2", "accept duel, {s2}"),
	("have_horse", "You don't have horse"),
]
