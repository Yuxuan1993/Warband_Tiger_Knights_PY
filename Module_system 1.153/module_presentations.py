...
from header_items import *#TU 6.23
import string
  ...
  ("battle",0,0,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
        ...
        (overlay_set_position, reg1, pos1),
                (overlay_set_position, reg1, pos1),
        (create_text_overlay, reg1, "@Formation", tf_center_justify|tf_single_line|tf_with_outline),
        (overlay_set_color, reg1, 0xFFAAAAAA),
        (position_set_x, pos1, 560),
        (overlay_set_position, reg1, pos1),
        ...
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but0_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but0_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but1_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but1_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but2_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but2_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but3_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but3_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but4_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but4_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but5_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but5_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but6_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but6_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but7_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but7_formation", s7, tf_center_justify),
        (try_end),
        (try_begin),
          ...
          (create_text_overlay, "$g_presentation_but8_weapon_usage", s7, tf_center_justify),
                  (create_text_overlay, "$g_presentation_but8_formation", s7, tf_center_justify),
        (try_end),
...
########################################
#MY MOD TU    
		(create_listbox_overlay, "$g_presentation_obj_battle_101", "str_space", 0),
		(overlay_add_item, "$g_presentation_obj_battle_101", "@No formation"),
		(overlay_add_item, "$g_presentation_obj_battle_101", "@Line"),
        (overlay_add_item, "$g_presentation_obj_battle_101", "@Rectangle"),
        (overlay_add_item, "$g_presentation_obj_battle_101", "@Circle"),
        
        (position_set_x, pos1, 400),
        (position_set_y, pos1, 600),
        (overlay_set_size, "$g_presentation_obj_battle_101", pos1),

                (val_add, ":y_position_for_order_buttons", -17),
        (position_set_x, pos1, 490),
        (position_set_y, pos1, ":y_position_for_order_buttons"),
                (val_add, ":y_position_for_order_buttons", 17),
        (overlay_set_position, "$g_presentation_obj_battle_101", pos1),

        (overlay_set_alpha, "$g_presentation_obj_battle_101", 0x60),
        (overlay_set_val, "$g_presentation_obj_battle_101", "$g_latest_order_4"),
###################################################
...
##MY MOD TU
        (else_try),
            (eq, ":object", "$g_presentation_obj_battle_101"),
            (call_script,"script_team_give_order_to_formation", ":value"),
            (call_script, "script_update_order_panel", ":player_team"),
############################
        (else_try),
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name0", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but0_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name0", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but0_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but1"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name1", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but1_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name1", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but1_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but2"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name2", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but2_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name2", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but2_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but3"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name3", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but3_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name3", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but3_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but4"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name4", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but4_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name4", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but4_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but5"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name5", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but5_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name5", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but5_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but6"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name6", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but6_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name6", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but6_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but7"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name7", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but7_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name7", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but7_formation", 250, 0),
          (try_end),
        (else_try),
          (eq, ":object", "$g_presentation_obj_battle_but8"),
          (try_begin),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name8", 250, 0xFFFFFF),
                        (overlay_animate_to_color, "$g_presentation_but8_formation", 250, 0xFFFFFF),
          (else_try),
            ...
            (overlay_animate_to_color, "$g_presentation_obj_battle_name8", 250, 0),
                        (overlay_animate_to_color, "$g_presentation_but8_formation", 250, 0),
          (try_end),
        (try_end),
        ]),
      (ti_on_presentation_run,
...
##        (gt, ":total_wage", 0),
      ...
      (overlay_set_position, reg1, pos1),
########## "budget_report" ####### pre ########### gongzi ###### TU #######
		(val_add, ":net_change", "$fysg_gongzi"),
###############
...
############  mini_map  #####  pre  ######## TU ############
	...
	[
		...
		[
			...
			(try_for_agents, ":agent_no"),
			  (agent_set_slot, ":agent_no", slot_agent_map_overlay_id, 0),
			  (agent_set_slot, ":agent_no", slot_agent_hp_id, 0),
			  (agent_set_slot, ":agent_no", slot_agent_back_hp_id, 0),
			(try_end),
		...
		[
		  (try_begin),
			  ...
			  (try_for_agents, ":cur_agent"),
				(agent_set_slot, ":cur_agent", slot_agent_map_overlay_id, 0),
				(agent_set_slot, ":cur_agent", slot_agent_hp_id, 0),
				(agent_set_slot, ":cur_agent", slot_agent_back_hp_id, 0),
			  (try_end),
			  (presentation_set_duration, 0),
		  (try_end),
		  ...
		  (try_begin),
			  (eq,"$hp_bar_flag", 0),
			  (try_for_agents, ":cur_agent"),
				(agent_get_slot, ":agent_overlay", ":cur_agent", slot_agent_hp_id),
				(agent_get_slot, ":agent_overlay_back", ":cur_agent", slot_agent_back_hp_id),
				(overlay_set_alpha, ":agent_overlay", 0),
				(overlay_set_alpha, ":agent_overlay_back", 0),
			  (try_end),
		  (else_try),
			  (eq,"$hp_bar_flag", 1),
			  (try_for_agents, ":cur_agent"),
				(agent_get_slot, ":agent_overlay", ":cur_agent", slot_agent_hp_id),
				(agent_get_slot, ":agent_overlay_back", ":cur_agent", slot_agent_back_hp_id),
				(overlay_set_alpha, ":agent_overlay", 0x44),
				(overlay_set_alpha, ":agent_overlay_back", 0x44),
			  (try_end),
		  (try_end),
		]),
	]),
...
################  dantiao  ###########  pre  ############# TU ####### 6.24 #####
   ("wy_duel_start_counter", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [      
    ...
    (ti_on_presentation_run, [
      ...
      (store_mission_timer_a, ":current_time"),
      (store_sub, ":seconds_past_in_duel_start", ":current_time", "$g_multiplayer_duel_start_time"),
      (store_sub, ":seconds_left_in_duel_start", 5, ":seconds_past_in_duel_start"),
      (try_begin),
        (le, ":seconds_left_in_duel_start", 0),
		(try_for_agents, ":cur_agent"),
			(agent_set_slot, ":cur_agent", slot_agent_map_overlay_id, 0),
...
######## pre ########### jiaolian ####### TU ############
("change_coach", 0, mesh_load_window, [
	(ti_on_presentation_load,
    [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		...
		(create_game_button_overlay, "$change_coach_done", "@Done"),
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$change_coach_done", pos1),

        (create_game_button_overlay, "$change_coach_go_back", "@Go back"),
        (position_set_x, pos1, 700),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$change_coach_go_back", pos1),

		(party_get_slot, ":troop_no","$current_town", slot_center_volunteer_troop_type),
		(str_store_troop_name, s10, ":troop_no"),
		(str_store_string, s10, "@The coach:{s10}"),
		(create_text_overlay, "$coach_txt", s10, tf_center_justify),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 650),
		(overlay_set_position, "$coach_txt", pos1),
        ...
        (try_for_range, ":cur_stack", 0, ":num_stacks"),
			...
			(troop_get_upgrade_troop,":next_troop",":cur_troop",0),
			(eq,":next_troop", 0),
			(position_move_y, pos1, -10),
            (str_store_troop_name, s2, ":cur_troop"),
            (create_game_button_overlay, reg0, "@{s2}"),
			(overlay_set_position, reg0, pos1),
			(party_set_slot, "p_temp_party", reg0, ":cur_troop"),
			(try_begin),
			...
			(try_end),
        (try_end),
		(assign,"$coach_troop_no","trp_player"),
		(try_begin),
    ...
    [
		...
		(try_begin),
			(eq, ":object", "$change_coach_done"),
			
			(try_begin),
				(neq,"$coach_troop_no","trp_player"),
				(party_set_slot, "$current_town", slot_center_volunteer_troop_type, "$root_troop_no"),
				(party_remove_members, "p_main_party", "$coach_troop_no", 1),
			(try_end),
			
			(presentation_set_duration, 0),
		(else_try),
            (eq, ":object", "$change_coach_go_back"),
            (presentation_set_duration, 0),
		(else_try),
			(party_get_slot, "$coach_troop_no", "p_temp_party", ":object"),
			(store_troop_faction, ":faction_no", "$coach_troop_no"),
			(call_script, "script_get_root_troop_to_reg11", ":faction_no"),
			(assign, "$root_troop_no", reg11),
			(str_store_troop_name, s10, "$root_troop_no"),
			(str_store_string, s10, "@The coach:{s10}"),
			(overlay_set_text, "$coach_txt", s10),
        (try_end),
	]),
]),
###################
...
("camp_mod_opition", 0, mesh_load_window, [
    (ti_on_presentation_load,
      [
		...
		(create_game_button_overlay, "$camp_mod_opition_done", "@Done"),
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$camp_mod_opition_done", pos1),
		
		(create_text_overlay, reg0, "@MOD OPITION", tf_center_justify),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 650),
		(overlay_set_position, reg0, pos1),
        ...
        (position_set_y, pos2, 600),
		(create_text_overlay, reg0, "@XP Bar:", tf_center_justify),
		(overlay_set_position, reg0, pos1),
		
		(create_check_box_overlay, "$xp_bar", "mesh_checkbox_off", "mesh_checkbox_on"),
		(overlay_set_position, "$xp_bar", pos2),
		(overlay_set_val, "$xp_bar", "$display_hp"),
		
		(position_move_y, pos1, -5),
		(position_move_y, pos2, -5),
		(create_text_overlay, reg0, "@Reinforcement stage youxian:", tf_center_justify),
		(overlay_set_position, reg0, pos1),
		(create_check_box_overlay, "$unlimited_reinforcement", "mesh_checkbox_off", "mesh_checkbox_on"),
		(overlay_set_position, "$unlimited_reinforcement", pos2),
		(overlay_set_val, "$unlimited_reinforcement", "$if_unlimited_reinforcement"),
		
		(position_move_y, pos1, -5),
		(position_move_y, pos2, -5),
		(create_text_overlay, "$reinforcement_stage_wenzi", "@Reinforcement stage:", tf_center_justify),
		(overlay_set_position, "$reinforcement_stage_wenzi", pos1),
		(create_number_box_overlay, "$reinforcement_stage", 2, 101),
		(overlay_set_position, "$reinforcement_stage", pos2),
		(overlay_set_val, "$reinforcement_stage", "$g_reinforcement_stage"),
		(try_begin),
		...
		(position_move_y, pos1, -5),
		(position_move_y, pos2, -5),
		(create_text_overlay, reg0, "@NPC clash STOP:", tf_center_justify),
		(overlay_set_position, reg0, pos1),
		(create_check_box_overlay, "$NPC_clash_stop", "mesh_checkbox_off", "mesh_checkbox_on"),
		(overlay_set_position, "$NPC_clash_stop", pos2),
		(overlay_set_val, "$NPC_clash_stop", "$disable_npc_complaints"),
		
		(position_move_y, pos1, -5),
		(position_move_y, pos2, -5),
		(create_text_overlay, reg0, "@Cheat mode:", tf_center_justify),
		(overlay_set_position, reg0, pos1),
		(create_check_box_overlay, "$cheat_box", "mesh_checkbox_off", "mesh_checkbox_on"),
		(overlay_set_position, "$cheat_box", pos2),
		(overlay_set_val, "$cheat_box", "$cheat_box_val"),
   ]),
	(ti_on_presentation_event_state_change,
     [
		(store_trigger_param_1, ":object"),
		...
		(try_begin),
			(eq, ":object", "$camp_mod_opition_done"),
            (presentation_set_duration, 0),
		(else_try),
            (eq, ":object", "$xp_bar"),
			(val_add, "$display_hp",1),
			(val_mod, "$display_hp",2),
		(else_try),
	...
	("duel_pre",0,0,[
		...
		[
			...
			(try_for_agents, ":cur_agent"),
				...
				(position_set_y, pos1, ":pos_y"),
				(str_store_troop_name, s2, ":cur_troop"),
				(create_button_overlay, reg0, "@{s2}", tf_center_justify|tf_single_line|tf_with_outline),
				(overlay_set_color, reg0, 0xFFAAAAAA),
				(overlay_set_position, reg0, pos1),
				(troop_set_slot,"p_temp_party",reg0,":cur_agent"),
			(try_end),
		]),
		(ti_on_presentation_event_state_change,
		[
			...
			(troop_get_slot, ":cur_agent", "p_temp_party", ":object"),
			(call_script, "script_team_get_duelist", "$team_1_head"),
			(call_script, "script_wy_set_temp_team", ":cur_agent", "$wy_duelist"),
			(call_script, "script_wy_remove_ammo"),#TU 6.23

			(assign, "$wy_duelist_ally", ":cur_agent"),
...
#########################
   ...
   ("wy_duel_text", prsntf_read_only|prsntf_manual_end_only, 0, [
    (ti_on_presentation_load, [
	  (assign,"$mini_map_flag",0),
      (set_fixed_point_multiplier, 1000),
    ...
    (ti_on_presentation_run, [
      ...
      (else_try),
        ...
        (overlay_set_text, "$g_multiplayer_duel_start_counter_overlay", s60),
      (try_end),
      ]),
	  (ti_on_presentation_load,
		[
...
############# pre ##### TU ######## mod_1 #####################
  ("dialog_text", 0, 0, [
	...
	[
		(set_fixed_point_multiplier, 1000),
		(init_position, pos1),
		(create_mesh_overlay, "$dialog_text_background", "mesh_white_plane"),
		(position_set_x, pos1, 0),
		(position_set_y, pos1, 0),
		(overlay_set_position, "$dialog_text_background", pos1),
		(position_set_x, pos1, 50000),
		(position_set_y, pos1, 60000),
		(overlay_set_size, "$dialog_text_background", pos1),
		(overlay_set_color, "$dialog_text_background", 0xFFFFFF),
		(overlay_set_alpha, "$dialog_text_background", 0),
		
		(str_clear, s0),
		(str_store_troop_name, s0, "$dialog_troop"),
		(create_text_overlay, reg0, s0, tf_left_align|tf_with_outline),
		(overlay_set_color, reg0, 0xFFFFFF),
		(position_set_x, pos1, 150+160),
		(position_set_y, pos1, 150),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 2000),
		(position_set_y, pos1, 2000),
		...
		(str_clear, s0),
		(str_store_string, s0, "$dialog_id"),
		(create_text_overlay, "$dialog_txt", s0, tf_left_align|tf_with_outline),
		(overlay_set_color, "$dialog_txt", 0xFFFFFF),
		(position_set_x, pos1, 150+160),
		(position_set_y, pos1, 0),
		(overlay_set_position, "$dialog_txt", pos1),
		(position_set_x, pos1, 1500),
		(position_set_y, pos1, 1500),
		(overlay_set_size, "$dialog_txt", pos1),
		...
		(position_set_y, pos1, 10000),
		(overlay_set_size, reg0, pos1),
		(overlay_set_color, reg0, 0xb2bebf),
		(overlay_set_alpha, reg0, 0x44),
		
		(troop_get_slot, ":troop_touxiang", "$dialog_troop", slot_troop_touxiang),
		(create_mesh_overlay, reg0, ":troop_touxiang"),
	...
	[
		...
		(try_begin),
			(eq, ":object", "$dialog_text_background"),
			(eq, ":mouse_state", 0),
			(val_add, "$dialog_id", 1),
			(val_sub, "$dialog_no", 1),
			(try_begin),
			...
			(else_try),
				(str_store_string, s0, "$dialog_id"),
				(overlay_set_text, "$dialog_txt", s0),
			(try_end),
		(try_end),
	]),
]),
...
############ TU #############
    ("separate_army", 0, mesh_load_window, [
        (ti_on_presentation_load,
            [
            (presentation_set_duration, 999999),
            (set_fixed_point_multiplier, 1000),

            (assign,"$separate_army_num",0),
       
            (create_game_button_overlay, "$separate_army_done", "@Done"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 25),
            (overlay_set_position, "$separate_army_done", pos1),

            (create_game_button_overlay, "$separate_army_done_2", "@Go back"),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 25),
            (overlay_set_position, "$separate_army_done_2", pos1),

            (create_text_overlay, reg1, "@Separate Army", tf_center_justify),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 630),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 2000),
            ...
            (position_set_x, pos1, 200),
            (position_set_y, pos1, 500),
            (create_text_overlay, reg1, "@The troop:", tf_center_justify),
            (overlay_set_position, reg1, pos1),
            (position_set_y, pos1, 470),
            (create_combo_button_overlay, "$separate_army_button_1"),
            (overlay_set_position, "$separate_army_button_1", pos1),
            ...
            (try_for_range, ":cur_stack", 0, ":num_stacks"),
                ...
                (neg|troop_is_hero,":cur_troop"),
                (neg|is_between, ":cur_troop", "trp_new_troop0", "trp_new_troop10"),
                (str_store_troop_name, s2, ":cur_troop"),
                #(display_message, "@{s2}"),
                (overlay_add_item, "$separate_army_button_1", "@{s2}"), 
            (try_end),
            (call_script, "script_party_copy", "p_temp_party", "p_main_party"),
            (party_get_num_companion_stacks, ":num_stacks", "p_temp_party"),
            (try_for_range, ":cur_stack", 0, ":num_stacks"),
                ...
                (neg|troop_is_hero,":cur_troop"),
                (neg|is_between,":cur_troop","trp_new_troop0","trp_new_troop10"),
                (assign,"$separate_army_troop_id",":cur_troop"),
                (party_stack_get_size, ":stack_size", "p_temp_party", ":cur_stack"),
                (assign,reg10,":stack_size"),
                (assign,":num_stacks",0),
            (try_end),
            (overlay_set_val, "$separate_army_button_1", 0),

            
            (create_number_box_overlay, "$separate_army_box_1", 0, 101),
            (position_set_x, pos1, 600),
            (position_set_y, pos1, 470),
            (overlay_set_position, "$separate_army_box_1", pos1),
            (overlay_set_val, "$separate_army_box_1", 0),
            ]),
        (ti_on_presentation_event_state_change,
          [
            (store_trigger_param_1, ":object"),
            ...
            (assign,":num",-1),
            (try_begin),
                (eq, ":object", "$separate_army_button_1"),
                (call_script, "script_party_copy", "p_temp_party", "p_main_party"),
                (party_get_num_companion_stacks, ":num_stacks", "p_temp_party"),
                (try_for_range, ":cur_stack", 0, ":num_stacks"),             
                    (party_stack_get_troop_id, ":cur_troop", "p_temp_party", ":cur_stack"),
                ...
                (try_end),
            (else_try),
                (eq, ":object", "$separate_army_box_1"),
                (assign,"$separate_army_num", ":value"),
            (else_try),
                (eq, ":object", "$separate_army_done"),
                (lt,"$separate_army_num",reg10),
                (gt,"$separate_army_num",0),
                (assign,":times",9),
                ...
                (call_script,"script_separate_army",":new_troop","$separate_army_troop_id"),
                (party_remove_members, "p_main_party", "$separate_army_troop_id", "$separate_army_num"),
                (party_add_members, "p_main_party", ":new_troop", "$separate_army_num"),
                (troop_set_slot,"trp_slot1", reg11, "$separate_army_troop_id"),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$separate_army_done_2"),
                (presentation_set_duration, 0),
            (try_end),
            ]),
    ]),
	
    ("merger_army", 0, mesh_load_window, [
        (ti_on_presentation_load,
            [
            (presentation_set_duration, 999999),
            (set_fixed_point_multiplier, 1000),

            #(assign,"$merger_army_num",0),
       
            (create_game_button_overlay, "$merger_army_done", "@Done"),
            (position_set_x, pos1, 900),
            (position_set_y, pos1, 25),
            (overlay_set_position, "$merger_army_done", pos1),

            (create_game_button_overlay, "$merger_army_done_2", "@Go back"),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 25),
            (overlay_set_position, "$merger_army_done_2", pos1),

            (create_text_overlay, reg1, "@Merger Army", tf_center_justify),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 630),
            (overlay_set_position, reg1, pos1),
            (position_set_x, pos1, 2000),
            ...
            (overlay_set_position, reg1, pos1),
            (position_set_y, pos1, 470),
            (create_combo_button_overlay, "$merger_army_button_1"),
            (overlay_set_position, "$merger_army_button_1", pos1),
            (call_script, "script_party_copy", "p_temp_party", "p_main_party"),
            (party_get_num_companion_stacks, ":num_stacks", "p_temp_party"),
            (try_for_range, ":cur_stack", 0, ":num_stacks"),
                (party_stack_get_troop_id, ":cur_troop", "p_temp_party", ":cur_stack"),
                (neg|troop_is_hero,":cur_troop"),
                (neg|is_between,":cur_troop","trp_new_troop0","trp_new_troop10"),
                (assign,"$merger_army_troop_id",":cur_troop"),
                (str_store_troop_name, s2, ":cur_troop"),
                (overlay_add_item, "$merger_army_button_1", "@{s2}"),
            (try_end),
            (call_script, "script_party_copy", "p_temp_party", "p_main_party"),
            (try_for_range, ":cur_stack", 0, ":num_stacks"),
                (party_stack_get_troop_id, ":cur_troop", "p_temp_party", ":cur_stack"),
                ...
                (assign,":num_stacks", 0),
            (try_end),
            (overlay_set_val, "$merger_army_button_1", 0),
            ]),
        (ti_on_presentation_event_state_change,
          [
            (store_trigger_param_1, ":object"),
            ...
            (assign,":num",-1),
            (try_begin),
                (eq, ":object", "$merger_army_button_1"),
                (call_script, "script_party_copy", "p_temp_party", "p_main_party"),
                (party_get_num_companion_stacks, ":num_stacks", "p_temp_party"),
                (try_for_range, ":cur_stack", 0, ":num_stacks"),
                    (party_stack_get_troop_id, ":cur_troop", "p_temp_party", ":cur_stack"),
                ...
                (try_end),
            (else_try),
                (eq, ":object", "$merger_army_done"),
                (assign,":times",9),
                (try_for_range, ":slot_no", 0, ":times"),
                    (troop_get_slot,":root_troop_id","trp_slot1",":slot_no"),
                    (eq,":root_troop_id","$merger_army_troop_id"),
                    (party_get_num_companion_stacks, ":num_stacks", "p_main_party"),
                    (store_add,":new_troop",":slot_no","trp_new_troop0"),
                    (try_for_range, ":cur_stack", 0, ":num_stacks"),
                        (party_stack_get_troop_id, ":cur_troop", "p_main_party", ":cur_stack"),
                        (eq,":new_troop",":cur_troop"),
                        (party_stack_get_size, ":stack_size", "p_main_party", ":cur_stack"),          
                        (party_remove_members, "p_main_party", ":new_troop", ":stack_size"),
                        (party_add_members, "p_main_party", "$merger_army_troop_id", ":stack_size"),
...
########### neizheng ############
("neizheng_center", 0, mesh_load_window, [
	(ti_on_presentation_load,
    [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		...
		(create_game_button_overlay, "$neizheng_center_done", "@Done"),
        (position_set_x, pos1, 900),
        (position_set_y, pos1, 25),
        (overlay_set_position, "$neizheng_center_done", pos1),		
		
		(str_store_string, s10, "@neizheng center"),
		(create_text_overlay, reg0, s10, tf_center_justify),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 650),
		(overlay_set_position, reg0, pos1),
		...
		(try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
			...
			(create_text_overlay, reg0, s2, tf_center_justify),
			(overlay_set_position, reg0, pos1),
			
			(copy_position, pos2, pos1),
			(party_get_num_companions, reg1, ":center_no"),
			(party_get_slot, reg2, ":center_no", slot_town_prosperity),
			(party_get_slot, reg3, ":center_no", slot_party_defense),
			(val_add, reg3, 50),
			(str_store_string, s1, "str_neizheng_details"),
			(create_text_overlay, reg0, s1, tf_center_justify),
			(position_move_x, pos2, 20),
			(position_move_y, pos2, -2),
			...
			(overlay_set_position, reg0, pos2),
			(party_set_slot, "p_temp_party", reg0, ":center_no"),
			(overlay_add_item, reg0, "@zhengbing"),
			(overlay_add_item, reg0, "@xunlian"),
			(overlay_add_item, reg0, "@jingji"),
			(overlay_add_item, reg0, "@chengfang"),
			(party_set_slot, ":center_no", slot_party_weekly_plan, 0),
        (try_end),
	]),
	(ti_on_presentation_event_state_change,
    [
		...
		(try_begin),
			(eq, ":object", "$neizheng_center_done"),
			(presentation_set_duration, 0),
		(else_try),
			(party_get_slot, ":center_id", "p_temp_party", ":object"),
			(party_set_slot, ":center_id", slot_party_weekly_plan, ":value"),
        (try_end),
	]),
]),
###############
...
("neizheng_center_2", 0, mesh_load_window, [
	(ti_on_presentation_load,
    [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		...
		(str_store_string, s10, "@neizheng detail"),
		(create_text_overlay, reg0, s10, tf_center_justify),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 650),
		(overlay_set_position, reg0, pos1),
		...
		(try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
			...
			(try_begin),
				(eq, ":weekly_plan", 0),
				(str_store_string, s1, "@zhengbing"),
			(else_try),
				(eq, ":weekly_plan", 1),
				(str_store_string, s1, "@xunlian"),
			(else_try),
				(eq, ":weekly_plan", 2),
				(str_store_string, s1, "@jingji"),
			(else_try),
				(eq, ":weekly_plan", 3),
				(str_store_string, s1, "@chengfang"),
			(try_end),
			(create_text_overlay, reg0, s1, tf_center_justify),
			(overlay_set_position, reg0, pos2),
        (try_end),
