...
(120,0,-0.500000,0.600000, "Lower Lip"),#Lower_Lip
(110,0,-0.200000,0.600000, "Upper Lip"),#Upper_Lip
...
skins = [
  (
    ...
    [[1.6, comp_greater_than, (1.0,face_width), (1.0,temple_width)], #constraints: ex: 1.7 > (face_width + temple_width)
