...
# module_constants.py
# ZZ juewei
slot_troop_title_level                 = 157
slot_troop_orginal_title_level         = 158
##############  con  #####  mini_map  ########
slot_agent_hp_id					   = 158
slot_agent_back_hp_id				   = 159
##########################
# Duel Mod Troop Slots 
 
slot_troop_duel_won 	 	 	 	 = 160 	 	 #duel mod - how many duels player won against this troop 
slot_troop_duel_lost 	 	 	   = 161 	 	 #duel mod - how many duels player lost against this troop 
slot_troop_duel_started 	 	 = 162 	 	 #duel mod - if player started dueling with this troop 
 
########## gongzi ###### con ##### TU ########
slot_faction_money = 303
slot_gongzi_next_month = 304
############
 
# Duel mod constants 
 
king_renown_for_duel = 500 	 	 # Minimum renown needed to challenge a king to a friendly duel 
lord_renown_for_duel = 150 	 	 # Minimum renown needed to challenge a king to a friendly duel 

slot_troop_adult_year = 400
slot_troop_dead_year  = 401
slot_troop_is_king    = 402

slot_troop_mod_knight_begin = "trp_knight_mod_1"
slot_troop_mod_knight_end = pretenders_begin

slot_agent_animation_now = 160
slot_troop_touxiang = 163



slot_agent_post_x = 161
slot_agent_post_y = 162
slot_agent_before = 163
slot_agent_next = 164

slot_team_flag_scene_prop = 100 #100--109
slot_team_length_between  = 110 #110--119
slot_team_formation_style  = 120 #120--129
slot_team_formation_direction  = 130 #130--139
slot_scene_agent_no = 100

slot_party_gk_order = 300
slot_party_weekly_plan = 301
slot_party_defense = 302

PI = 3.1415926
jinzan = 0x1000000000000000

slot_troop_born_father = 164
slot_troop_born_guardian = 165
slot_troop_born_faction = 166

juewei_begin = "str_jw_0"
guanzi_begin = "str_gz_1"

slot_troop_town = 167

slot_troop_jineng = 464
slot_troop_jinengdian = 465
slot_troop_jineng_flag = 466
slot_troop_jineng_object = 467
slot_troop_jineng_time_begin = 468
slot_troop_jineng_pos_x = 469
slot_troop_jineng_pos_y = 470
slot_party_jineng_kongchengji_flag = 451
slot_party_jineng_kongchengji_begin = 452
...
########### jineng_xiaobing #########
slot_troop_jineng_have_during = 500
slot_troop_is_player_teacher = 501

####### duotizi #####
slot_agent_siege_state = 165
slot_agent_target_ladder = 166
slot_agent_anim_flag = 167
###############

########## fuluwujiang #######
slot_troop_fuluwujiang = 502
#################

########## beiyongxue #######
slot_agent_hero_xue = 168
#################