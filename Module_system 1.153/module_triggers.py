...
(24*7,0,0,[],
	[
	(try_for_range, ":cur_troop", "trp_kingdom_heroes_including_player_begin", "trp_heroes_end"),
		(troop_get_slot, ":title", ":cur_troop", slot_troop_title_level),
		(neq, ":title", 0),
		(store_mul,":fenglu",":title",500),
		(troop_add_gold,":cur_troop",":fenglu"),
	(try_end),
	(troop_get_slot, ":title", "trp_player", slot_troop_title_level),
	(neq, ":title", 0),
	(store_mul,":fenglu",":title",500),
	(troop_add_gold,":cur_troop",":fenglu"),
...
(24, 0, ti_once, 
	[
		(store_faction_of_party, ":faction_no", "p_castle_31"),
		(eq, ":faction_no", "fac_kingdom_6"),
		(store_faction_of_party, ":faction_no", "p_town_6"),
		(eq, ":faction_no", "fac_kingdom_6"),
		(eq, "$mod_no", 1),
	...
	[
	(store_current_day, "$hulaoguan_time_begin"),
	(assign, "$hulaoguan_phase", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_1", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_2", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_3", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_5", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_7", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_8", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_11", "fac_kingdom_6", 1),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_12", "fac_kingdom_6", 1),
	
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_10", "fac_kingdom_6", 1),
	
	(call_script, "script_change_faction_marshall", "fac_kingdom_1"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_2"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_3"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_5"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_7"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_8"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_11"),   
	(call_script, "script_change_faction_marshall", "fac_kingdom_12"),  
	
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_1", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_2", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_3", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_5", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_7", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_8", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_11", "trp_kingdom_3_lord"),   
	(call_script, "script_appoint_faction_marshall", "fac_kingdom_12", "trp_kingdom_3_lord"),  

	(call_script, "script_appoint_faction_marshall", "fac_kingdom_6", "trp_kingdom_6_lord"), 
	]),
###########################################
# (1, 0, ti_once, 
	# [
...
############ jineng_xiaobing #######################
    ...
    [
        ...
        (rest_for_hours_interactive, 9999, "$speed_of_wait", 0),
    ]),

	#  CHECKS IF "$teacher_party" IS DEFEATED
    (0.0, 0, 0, [
        (eq, "$freelancer_state", 1),
        (gt, "$teacher_party", 0),
        (neg|party_is_active, "$teacher_party"),
    ],
    [
		...
		(store_troop_faction, ":commander_faction", "$teacher_lord"),
    ...
    (0.0, 0, 0, [
        ...
        (party_get_battle_opponent, ":commander_enemy", "$teacher_party"),
    ...
    [
		(val_add, "$speed_of_wait", 1),
		(val_min, "$speed_of_wait", 15),
        (rest_for_hours_interactive, 24 * 365, "$speed_of_wait", 1),
		(assign, reg0, "$speed_of_wait"),
		(display_message, "@Speed:{reg0}", 0xFFFFAAAA),
    ]),
    ...
    [
		(val_sub, "$speed_of_wait", 1),
		(val_max, "$speed_of_wait", 1),
        (rest_for_hours_interactive, 24 * 365, "$speed_of_wait", 1),
		(assign, reg0, "$speed_of_wait"),
		(display_message, "@Speed:{reg0}", 0xFFFFAAAA),
    ]),
