...
##############
wuzhongshengyou_enemy = [
		(assign, ":continue", 0),
		(party_get_num_companion_stacks, ":num_stacks", "$g_enemy_party"),   
		(try_for_range, ":cur_stack", 0, ":num_stacks"),
			(party_stack_get_troop_id, ":cur_troop", "$g_enemy_party", ":cur_stack"),
			(troop_is_hero,":cur_troop"),
			(troop_get_slot, ":jineng_no", ":cur_troop", slot_troop_jineng),
			(troop_get_slot, ":jinengdian", ":cur_troop", slot_troop_jinengdian),
			(eq, ":jineng_no", wuzhongshengyou),
			(ge, ":jinengdian", 8),
			(assign, ":num_stacks", 0),
			(assign, ":continue", 1),
		...
		(troop_get_slot, ":jinengdian", reg1, slot_troop_jinengdian),
		(val_sub, ":jinengdian", 8),
		(troop_set_slot, reg1, slot_troop_jinengdian, ":jinengdian"),
		(set_spawn_radius,1),
		(spawn_around_party, "$g_enemy_party", "pt_kingdom_hero_party"),
		(assign, "$wuzhongparty_enemy", reg(0)),
		(party_get_num_companion_stacks, ":num_stacks", "$g_enemy_party"),
		(try_for_range, ":cur_stack", 0, ":num_stacks"),
			(party_stack_get_troop_id, ":cur_troop", "$g_enemy_party", ":cur_stack"),
			(neg|troop_is_hero, ":cur_troop"),
			(party_stack_get_size, ":troop_num", "$g_enemy_party", ":cur_stack"),
			(val_div, ":troop_num", 5),
			(party_add_members, "$wuzhongparty_enemy", ":cur_troop", ":troop_num"),
		(try_end),
		(party_quick_attach_to_current_battle, "$wuzhongparty_enemy", 1),
...
pre_join_freelancer = [
		  ...
		  (try_begin),
			(party_get_attached_to, ":attached", "$teacher_party"),
			(this_or_next|eq, "$teacher_party", "$g_encountered_party_2"),
...
join_siege_outside_freelancer = [
          (eq, "$freelancer_state", 1),
		  (try_begin),
			(store_troop_faction, ":commanders_faction", "$teacher_lord"),
...
######### TU ##### jineng ## 6.23 ##
jineng_menu_battle = ("camp_jineng",[(troop_slot_ge, "trp_player", slot_troop_jineng, 1),],"jineng",
		   [(jump_to_menu, "mnu_jineng_menu_battle"),
			])
##################
...
############ TU ##########
	  ...
	  (try_for_range, ":cur_troop", lords_begin, lords_end),
		(troop_slot_eq, ":cur_troop", slot_troop_is_king, -1),
        (store_random_in_range, ":age", 27, 42),
      ...
      (troop_set_slot, "trp_kingdom_1_lord", slot_troop_age, 42), 
      (troop_set_slot, "trp_knight_1_1", slot_troop_age, 39), 
      (troop_set_slot, "trp_knight_1_2", slot_troop_age, 22), 
      (troop_set_slot, "trp_knight_1_3", slot_troop_age, 38), 
      (troop_set_slot, "trp_knight_1_4", slot_troop_age, 20), 
      (troop_set_slot, "trp_knight_1_5", slot_troop_age, 37), 
      (troop_set_slot, "trp_knight_1_6", slot_troop_age, 37), 
      (troop_set_slot, "trp_knight_1_7", slot_troop_age, 20), 
      (troop_set_slot, "trp_knight_1_10", slot_troop_age, 38), 
      (troop_set_slot, "trp_knight_1_12", slot_troop_age, 30), 
      (troop_set_slot, "trp_knight_1_13", slot_troop_age, 38), 
      (troop_set_slot, "trp_knight_1_17", slot_troop_age, 36), 
      (troop_set_slot, "trp_knight_1_18", slot_troop_age, 36), 
      (troop_set_slot, "trp_knight_1_19", slot_troop_age, 26), 
      (troop_set_slot, "trp_knight_1_20", slot_troop_age, 20), 
      (troop_set_slot, "trp_kingdom_1_lady_1", slot_troop_age, 39), 
      (troop_set_slot, "trp_kingdom_1_lady_2", slot_troop_age, 19), 
	  (troop_set_slot, "trp_kingdom_1_lady_3", slot_troop_age, 18),
	  (troop_set_slot, "trp_kingdom_1_lady_5", slot_troop_age, 18),
	  (troop_set_slot, "trp_kingdom_1_lady_8", slot_troop_age, 19),

      (troop_set_slot, "trp_novice_fighter", slot_troop_father, "trp_tutorial_archer"), 
      (troop_set_slot, "trp_tutorial_swordsman", slot_troop_father, "trp_tutorial_archer"), 
      (troop_set_slot, "trp_kingdom_1_lord", slot_troop_father, "trp_tutorial_swordsman"), 
      (troop_set_slot, "trp_knight_1_3", slot_troop_father, "trp_tutorial_swordsman"), 
      (troop_set_slot, "trp_knight_1_18", slot_troop_father, "trp_tutorial_swordsman"), 
      (troop_set_slot, "trp_knight_1_1", slot_troop_father, "trp_novice_fighter"),
      (troop_set_slot, "trp_knight_1_10", slot_troop_father, "trp_novice_fighter"),
      (troop_set_slot, "trp_knight_1_2", slot_troop_father, "trp_kingdom_1_lord"),
      (troop_set_slot, "trp_knight_1_7", slot_troop_father, "trp_kingdom_1_lord"),
      (troop_set_slot, "trp_knight_1_13", slot_troop_father, "trp_regular_fighter"),
      (troop_set_slot, "trp_knight_1_17", slot_troop_father, "trp_regular_fighter"),
      (troop_set_slot, "trp_knight_1_19", slot_troop_father, "trp_tutorial_swordsman"),
      (troop_set_slot, "trp_knight_1_20", slot_troop_father, "trp_knight_1_10"),
      (troop_set_slot, "trp_knight_1_4", slot_troop_spouse, "trp_knight_1_2"), 
      (troop_set_slot, "trp_knight_1_2", slot_troop_spouse, "trp_knight_1_4"),
      ...
      (troop_set_slot, "trp_kingdom_1_lady_2", slot_troop_father, "trp_kingdom_1_lord"),
	  (troop_set_slot, "trp_kingdom_1_lady_3", slot_troop_father, "trp_knight_1_18"),
	  (troop_set_slot, "trp_knight_1_17", slot_troop_spouse, "trp_kingdom_1_lady_4"), 
      (troop_set_slot, "trp_kingdom_1_lady_4", slot_troop_spouse, "trp_knight_1_17"),
	  (troop_set_slot, "trp_kingdom_1_lady_5", slot_troop_father, "trp_knight_1_6"),
      (troop_set_slot, "trp_knight_1_8", slot_troop_spouse, "trp_kingdom_1_lady_6"), 
      (troop_set_slot, "trp_kingdom_1_lady_6", slot_troop_spouse, "trp_knight_1_8"),
	  (troop_set_slot, "trp_knight_1_9", slot_troop_spouse, "trp_kingdom_1_lady_7"), 
      (troop_set_slot, "trp_kingdom_1_lady_7", slot_troop_spouse, "trp_knight_1_9"),
	  (troop_set_slot, "trp_kingdom_1_lady_8", slot_troop_father, "trp_knight_1_3"),
	  
      (troop_set_slot, "trp_kingdom_2_lord", slot_troop_age, 41), 
      (troop_set_slot, "trp_knight_2_1", slot_troop_age, 38), 
      (troop_set_slot, "trp_knight_2_2", slot_troop_age, 37), 
      (troop_set_slot, "trp_knight_2_3", slot_troop_age, 33), 
      (troop_set_slot, "trp_knight_2_4", slot_troop_age, 33), 
      (troop_set_slot, "trp_knight_2_5", slot_troop_age, 33),
      (troop_set_slot, "trp_knight_2_6", slot_troop_age, 27),
      (troop_set_slot, "trp_knight_2_7", slot_troop_age, 51),
      (troop_set_slot, "trp_knight_2_8", slot_troop_age, 21),
      (troop_set_slot, "trp_knight_2_9", slot_troop_age, 33),
      (troop_set_slot, "trp_knight_2_10", slot_troop_age, 33),
      (troop_set_slot, "trp_knight_2_11", slot_troop_age, 17),
      (troop_set_slot, "trp_knight_2_12", slot_troop_age, 26),
      (troop_set_slot, "trp_knight_2_13", slot_troop_age, 34), 
      (troop_set_slot, "trp_knight_2_14", slot_troop_age, 28),   
      (troop_set_slot, "trp_knight_2_15", slot_troop_age, 27), 
      (troop_set_slot, "trp_knight_2_16", slot_troop_age, 40), 
      (troop_set_slot, "trp_knight_2_17", slot_troop_age, 20),
      (troop_set_slot, "trp_knight_2_18", slot_troop_age, 19), 
      (troop_set_slot, "trp_knight_2_19", slot_troop_age, 37), 
      (troop_set_slot, "trp_knight_2_20", slot_troop_age, 23), 
      (troop_set_slot, "trp_kingdom_2_lady_1", slot_troop_age, 35), 
      (troop_set_slot, "trp_kingdom_2_lady_2", slot_troop_age, 19), 
      (troop_set_slot, "trp_kingdom_2_lady_3", slot_troop_age, 35), 
      (troop_set_slot, "trp_kingdom_2_lady_4", slot_troop_age, 35), 
	  (troop_set_slot, "trp_kingdom_2_lady_5", slot_troop_age, 19),
      (troop_set_slot, "trp_kingdom_2_lady_6", slot_troop_age, 25), 
      (troop_set_slot, "trp_kingdom_2_lady_7", slot_troop_age, 25), 
      (troop_set_slot, "trp_kingdom_2_lady_8", slot_troop_age, 15),
	  
      (troop_set_slot, "trp_kingdom_2_lord", slot_troop_father, "trp_temp_troop"), 
      ...
      (troop_set_slot, "trp_knight_2_1", slot_troop_father, "trp_temp_troop"), 
      (troop_set_slot, "trp_knight_2_1", slot_troop_spouse, "trp_kingdom_2_lady_3"), 
      (troop_set_slot, "trp_kingdom_2_lady_3", slot_troop_spouse, "trp_knight_2_1"), 
      (troop_set_slot, "trp_knight_2_2", slot_troop_father, "trp_temp_troop"), 
      ...
      (troop_set_slot, "trp_knight_2_3", slot_troop_father, "trp_temp_troop"), 
      (troop_set_slot, "trp_knight_2_4", slot_troop_father, "trp_tournament_participants"),  
      (troop_set_slot, "trp_kingdom_2_lady_5", slot_troop_father, "trp_knight_2_5"),  
      (troop_set_slot, "trp_knight_2_6", slot_troop_spouse, "trp_kingdom_2_lady_6"), 
      (troop_set_slot, "trp_kingdom_2_lady_6", slot_troop_spouse, "trp_knight_2_6"),   
      (troop_set_slot, "trp_knight_2_8", slot_troop_father, "trp_knight_2_1"), 
      (troop_set_slot, "trp_knight_2_9", slot_troop_father, "trp_arena_training_fighter_2"),
      (troop_set_slot, "trp_knight_2_9", slot_troop_spouse, "trp_knight_2_12"),  
      (troop_set_slot, "trp_knight_2_12", slot_troop_spouse, "trp_knight_2_9"),    
      (troop_set_slot, "trp_knight_2_11", slot_troop_father, "trp_knight_2_2"),  
      (troop_set_slot, "trp_knight_2_13", slot_troop_spouse, "trp_knight_2_14"), 
      (troop_set_slot, "trp_knight_2_14", slot_troop_spouse, "trp_knight_2_13"), 
      (troop_set_slot, "trp_knight_2_15", slot_troop_father, "trp_tournament_participants"), 
      (troop_set_slot, "trp_knight_2_16", slot_troop_father, "trp_random_town_sequence"),  
      (troop_set_slot, "trp_knight_2_17", slot_troop_father, "trp_knight_2_2"),  
      (troop_set_slot, "trp_knight_2_18", slot_troop_father, "trp_knight_2_1"), 
      (troop_set_slot, "trp_knight_2_19", slot_troop_father, "trp_random_town_sequence"), 
      (troop_set_slot, "trp_knight_2_20", slot_troop_father, "trp_kingdom_2_lord"), 
      (troop_set_slot, "trp_kingdom_2_lady_1", slot_troop_father, "trp_random_town_sequence"),
      (troop_set_slot, "trp_kingdom_2_lady_7", slot_troop_father, "trp_knight_2_7"),
      (troop_set_slot, "trp_kingdom_2_lady_8", slot_troop_father, "trp_knight_2_10"), 
	  
      (troop_set_slot, "trp_kingdom_3_lord", slot_troop_age, 45), 
      (troop_set_slot, "trp_knight_3_1", slot_troop_age, 39),
      (troop_set_slot, "trp_knight_3_2", slot_troop_age, 37),
      (troop_set_slot, "trp_knight_3_15", slot_troop_age, 25),
      (troop_set_slot, "trp_knight_3_18", slot_troop_age, 24),
      (troop_set_slot, "trp_knight_3_20", slot_troop_age, 22),
      (troop_set_slot, "trp_kingdom_3_lady_2", slot_troop_age, 19),
      (troop_set_slot, "trp_kingdom_3_lady_3", slot_troop_age, 17),
	  (troop_set_slot, "trp_kingdom_3_lady_7", slot_troop_age, 17),
	  (troop_set_slot, "trp_kingdom_3_lady_8", slot_troop_age, 18),

      (troop_set_slot, "trp_kingdom_3_lord", slot_troop_spouse, "trp_kingdom_3_lady_1"), 
      (troop_set_slot, "trp_kingdom_3_lady_1", slot_troop_spouse, "trp_kingdom_3_lord"), 
      (troop_set_slot, "trp_knight_3_1", slot_troop_father, "trp_veteran_fighter"), 
      (troop_set_slot, "trp_knight_3_2", slot_troop_father, "trp_veteran_fighter"), 
      (troop_set_slot, "trp_knight_3_15", slot_troop_father, "trp_kingdom_3_lord"), 
      (troop_set_slot, "trp_knight_3_18", slot_troop_father, "trp_kingdom_3_lord"), 
      (troop_set_slot, "trp_knight_3_20", slot_troop_father, "trp_kingdom_3_lord"), 
      (troop_set_slot, "trp_kingdom_3_lady_2", slot_troop_father, "trp_knight_3_1"), 
      (troop_set_slot, "trp_kingdom_3_lady_3", slot_troop_father, "trp_knight_3_2"), 
      ...
      (troop_set_slot, "trp_knight_3_11", slot_troop_spouse, "trp_kingdom_3_lady_5"), 
      (troop_set_slot, "trp_kingdom_3_lady_5", slot_troop_spouse, "trp_knight_3_11"), 
      (troop_set_slot, "trp_knight_3_16", slot_troop_spouse, "trp_kingdom_3_lady_6"), 
      (troop_set_slot, "trp_kingdom_3_lady_6", slot_troop_spouse, "trp_knight_3_16"), 
	  (troop_set_slot, "trp_kingdom_3_lady_7", slot_troop_father, "trp_knight_3_3"),
	  (troop_set_slot, "trp_kingdom_3_lady_8", slot_troop_father, "trp_knight_3_5"),
	  
	  (troop_set_slot, "trp_kingdom_4_lord", slot_troop_age, 43), 
	  (troop_set_slot, "trp_kingdom_4_lady_1", slot_troop_age, 20), 
	  (troop_set_slot, "trp_kingdom_4_lady_3", slot_troop_age, 21), 
	  (troop_set_slot, "trp_kingdom_4_lady_5", slot_troop_age, 19),
	  (troop_set_slot, "trp_kingdom_4_lady_8", slot_troop_age, 22),
	  (troop_set_slot, "trp_kingdom_4_lady_1", slot_troop_father, "trp_kingdom_4_lord"),
	  (troop_set_slot, "trp_knight_4_1", slot_troop_guardian, "trp_knight_4_2"),
	  (troop_set_slot, "trp_knight_4_1", slot_troop_spouse, "trp_kingdom_4_lady_2"), 
      (troop_set_slot, "trp_kingdom_4_lady_2", slot_troop_spouse, "trp_knight_4_1"),
	  (troop_set_slot, "trp_kingdom_4_lady_3", slot_troop_guardian, "trp_knight_4_4"),
	  (troop_set_slot, "trp_knight_4_5", slot_troop_spouse, "trp_kingdom_4_lady_4"), 
      (troop_set_slot, "trp_kingdom_4_lady_4", slot_troop_spouse, "trp_knight_4_5"),
	  (troop_set_slot, "trp_kingdom_4_lady_5", slot_troop_father, "trp_knight_4_5"),
	  (troop_set_slot, "trp_knight_4_16", slot_troop_spouse, "trp_kingdom_4_lady_6"), 
      (troop_set_slot, "trp_kingdom_4_lady_6", slot_troop_spouse, "trp_knight_4_16"),
	  (troop_set_slot, "trp_knight_4_18", slot_troop_spouse, "trp_kingdom_4_lady_7"), 
      (troop_set_slot, "trp_kingdom_4_lady_7", slot_troop_spouse, "trp_knight_4_18"),
	  (troop_set_slot, "trp_kingdom_4_lady_8", slot_troop_father, "trp_knight_4_10"),
	  
      (troop_set_slot, "trp_kingdom_5_lord", slot_troop_age, 52), 
      (troop_set_slot, "trp_knight_5_1", slot_troop_age, 40),
      (troop_set_slot, "trp_knight_5_2", slot_troop_age, 51),
      (troop_set_slot, "trp_knight_5_3", slot_troop_age, 36), 
      (troop_set_slot, "trp_knight_5_4", slot_troop_age, 47), 
      (troop_set_slot, "trp_knight_5_5", slot_troop_age, 27), 
      (troop_set_slot, "trp_knight_5_6", slot_troop_age, 32), 
      (troop_set_slot, "trp_knight_5_7", slot_troop_age, 19), 
      (troop_set_slot, "trp_knight_5_8", slot_troop_age, 24), 
      (troop_set_slot, "trp_knight_5_9", slot_troop_age, 34), 
      (troop_set_slot, "trp_knight_5_10", slot_troop_age, 31), 
      (troop_set_slot, "trp_knight_5_11", slot_troop_age, 33), 
      (troop_set_slot, "trp_knight_5_12", slot_troop_age, 30),
      (troop_set_slot, "trp_knight_5_13", slot_troop_age, 23), 
      (troop_set_slot, "trp_knight_5_14", slot_troop_age, 34),
      (troop_set_slot, "trp_knight_5_15", slot_troop_age, 31),
      (troop_set_slot, "trp_knight_5_16", slot_troop_age, 31), 
      (troop_set_slot, "trp_knight_5_17", slot_troop_age, 31), 
      (troop_set_slot, "trp_knight_5_18", slot_troop_age, 31), 
      (troop_set_slot, "trp_knight_5_19", slot_troop_age, 31), 
      (troop_set_slot, "trp_knight_5_20", slot_troop_age, 28), 
      (troop_set_slot, "trp_kingdom_5_lady_1", slot_troop_age, 43),
      (troop_set_slot, "trp_kingdom_5_lady_2", slot_troop_age, 18), 
      (troop_set_slot, "trp_kingdom_5_lady_3", slot_troop_age, 45),
      (troop_set_slot, "trp_kingdom_5_lady_4", slot_troop_age, 24), 
	  (troop_set_slot, "trp_kingdom_5_lady_5", slot_troop_age, 18),
	  (troop_set_slot, "trp_kingdom_5_lady_6", slot_troop_age, 16),
	  (troop_set_slot, "trp_kingdom_5_lady_8", slot_troop_age, 17),
      ...
      (troop_set_slot, "trp_knight_5_2", slot_troop_spouse, "trp_kingdom_5_lady_3"), 
	  (troop_set_slot, "trp_kingdom_5_lady_3", slot_troop_spouse, "trp_knight_5_2"), 
	  (troop_set_slot, "trp_kingdom_5_lady_4", slot_troop_father, "trp_knight_5_4"),
      (troop_set_slot, "trp_knight_5_3", slot_troop_father, "trp_kingdom_5_lord"),
      (troop_set_slot, "trp_knight_5_3", slot_troop_spouse, "trp_knight_5_5"), 
      (troop_set_slot, "trp_knight_5_5", slot_troop_spouse, "trp_knight_5_3"), 
      (troop_set_slot, "trp_knight_5_6", slot_troop_father, "trp_kingdom_5_lord"),
      (troop_set_slot, "trp_knight_5_7", slot_troop_spouse, "trp_kingdom_5_lady_5"),
      (troop_set_slot, "trp_kingdom_5_lady_5", slot_troop_spouse, "trp_knight_5_7"),  	  
	  (troop_set_slot, "trp_kingdom_5_lady_5", slot_troop_father, "trp_knight_5_3"),
	  (troop_set_slot, "trp_kingdom_5_lady_6", slot_troop_father, "trp_knight_5_9"),
      (troop_set_slot, "trp_knight_5_8", slot_troop_father, "trp_kingdom_5_lord"),
      (troop_set_slot, "trp_knight_5_9", slot_troop_father, "trp_arena_training_fighter_2"),
      (troop_set_slot, "trp_knight_5_10", slot_troop_spouse, "trp_kingdom_5_lady_7"), 
      (troop_set_slot, "trp_knight_5_11", slot_troop_father, "trp_tutorial_maceman"), 
      (troop_set_slot, "trp_knight_5_12", slot_troop_spouse, "trp_knight_5_13"), 
      (troop_set_slot, "trp_knight_5_13", slot_troop_spouse, "trp_knight_5_12"),  
      (troop_set_slot, "trp_knight_5_14", slot_troop_father, "trp_tutorial_maceman"), 
      (troop_set_slot, "trp_knight_5_15", slot_troop_father, "trp_tutorial_maceman"),  
      (troop_set_slot, "trp_kingdom_5_lady_7", slot_troop_spouse, "trp_knight_5_10"),
	  (troop_set_slot, "trp_kingdom_5_lady_8", slot_troop_father, "trp_knight_5_14"),
	  
      (troop_set_slot, "trp_kingdom_6_lord", slot_troop_age, 58), 
      (troop_set_slot, "trp_knight_6_1", slot_troop_age, 38),
      (troop_set_slot, "trp_knight_6_4", slot_troop_age, 36),
      (troop_set_slot, "trp_knight_6_11", slot_troop_age, 40),
      (troop_set_slot, "trp_knight_6_12", slot_troop_age, 23),
	  (troop_set_slot, "trp_kingdom_6_lady_2", slot_troop_age, 20),
      (troop_set_slot, "trp_kingdom_6_lady_4", slot_troop_age, 18),
      (troop_set_slot, "trp_kingdom_6_lady_6", slot_troop_age, 36),
      (troop_set_slot, "trp_kingdom_6_lady_7", slot_troop_age, 20),
	  (troop_set_slot, "trp_kingdom_6_lady_8", slot_troop_age, 19),

      (troop_set_slot, "trp_kingdom_6_lord", slot_troop_spouse, "trp_kingdom_6_lady_1"),
      (troop_set_slot, "trp_kingdom_6_lady_1", slot_troop_spouse, "trp_kingdom_6_lord"), 
	  (troop_set_slot, "trp_kingdom_6_lady_2", slot_troop_father, "trp_knight_6_8"),
      (troop_set_slot, "trp_knight_6_1", slot_troop_father, "trp_kingdom_6_lord"),
      (troop_set_slot, "trp_knight_6_12", slot_troop_spouse, "trp_knight_6_1"),
      (troop_set_slot, "trp_knight_6_1", slot_troop_spouse, "trp_knight_6_12"),
      (troop_set_slot, "trp_kingdom_6_lady_3", slot_troop_spouse, "trp_knight_6_2"),  
      (troop_set_slot, "trp_knight_6_2", slot_troop_spouse, "trp_kingdom_6_lady_3"), 
      (troop_set_slot, "trp_kingdom_6_lady_4", slot_troop_father, "trp_knight_6_4"),  
      (troop_set_slot, "trp_knight_6_6", slot_troop_spouse, "trp_kingdom_6_lady_5"), 
      (troop_set_slot, "trp_kingdom_6_lady_5", slot_troop_spouse, "trp_knight_6_6"),  
      (troop_set_slot, "trp_knight_6_11", slot_troop_spouse, "trp_kingdom_6_lady_6"), 
      (troop_set_slot, "trp_kingdom_6_lady_6", slot_troop_spouse, "trp_knight_6_11"),  
      (troop_set_slot, "trp_kingdom_6_lady_7", slot_troop_father, "trp_knight_6_11"), 
	  (troop_set_slot, "trp_kingdom_6_lady_8", slot_troop_father, "trp_knight_6_17"),
	  
	  (try_for_range, ":cur_troop", kings_begin, kingdom_ladies_end),
        (troop_get_slot, ":age", ":cur_troop", slot_troop_age),
		(store_sub, ":age", 194, ":age"),
        (troop_set_slot, ":cur_troop", slot_troop_age, ":age"),
      (try_end),

      (try_for_range, ":troop_no", kings_begin, kings_end),
		(neg|troop_slot_eq, ":troop_no", slot_troop_is_king, -1),
      ...
      (try_for_range, ":troop_no", pretenders_begin, pretenders_end),
        (troop_set_note_available, ":troop_no", 1),
      (try_end),
	  (try_for_range, ":troop_id", slot_troop_mod_knight_begin, slot_troop_mod_knight_end),
			(troop_set_faction, ":troop_id", "fac_unborn"),
			(troop_get_slot, ":troop_id_2", ":troop_id", slot_troop_spouse),
			(troop_set_slot, ":troop_id", slot_troop_spouse, -1), 
			(try_begin),
				(gt, ":troop_id_2", 0),
				(troop_set_slot, ":troop_id_2", slot_troop_spouse, -1), 
				(call_script, "script_get_kingdom_lady_social_determinants", ":troop_id_2"),
				(try_begin),
					(eq, reg0, ":troop_id_2"),
					(troop_get_slot, ":party_no", ":troop_id_2", slot_troop_leaded_party),
					(try_begin),
						(gt, ":party_no", 0),
						(remove_party, ":party_no"),
					(try_end),
					(try_for_range, ":center_no", walled_centers_begin, villages_end),
						(party_slot_eq, ":center_no", slot_town_lord, ":troop_id_2"),
						(party_set_slot, ":center_no", slot_town_lord, stl_unassigned),
						(party_set_banner_icon, ":center_no", 0),#Removing banner
					(try_end),
					(troop_set_note_available, ":troop_id_2", 0),
				(try_end),
			(try_end),
			...
			(try_end),
			(try_for_range, ":center_no", walled_centers_begin, villages_end),
				(party_slot_eq, ":center_no", slot_town_lord, ":troop_id"),
				(party_set_slot, ":center_no", slot_town_lord, stl_unassigned),
				(party_set_banner_icon, ":center_no", 0),#Removing banner
			(try_end),
			(troop_set_note_available, ":troop_id", 0),
      (try_end),
      ...
      (try_end),
      (faction_set_note_available, "fac_neutral_new", 0),
	  (faction_set_note_available, "fac_unborn", 0),
	  (faction_set_note_available, "fac_undeads", 0),
	  (faction_set_note_available, "fac_kingdom_7", 0),
	  (faction_set_note_available, "fac_kingdom_8", 0),
	  (faction_set_note_available, "fac_kingdom_9", 0),
	  (faction_set_note_available, "fac_kingdom_10", 0),
	  (faction_set_note_available, "fac_kingdom_11", 0),
	  (faction_set_note_available, "fac_kingdom_12", 0),
	  
      (try_for_range, ":party_no", centers_begin, centers_end),
        (party_set_note_available, ":party_no", 1),
      (try_end),
	  
	  (faction_set_note_available, "fac_neutral", 0),#TU 7.4
...
############ TU ##########
	  (assign, "$mod_no", 1),
	  (assign, "$hulaoguan_time_begin", 10000),
	  (assign, "$hulaoguan_phase", 0),
	  
	 (try_for_range, ":faction_id", "fac_kingdom_1", "fac_kingdom_7"),
		(faction_get_slot, ":faction_king", ":faction_id", slot_faction_leader),
		(str_store_troop_name, s0, ":faction_king"),
	  ...
	  (troop_set_faction, "trp_knight_1_11", "fac_kingdom_10"),
	  (troop_set_faction, "trp_knight_1_17", "fac_kingdom_6"),
	  (troop_set_faction, "trp_knight_2_3", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_5_11", "fac_kingdom_8"),
	  (troop_set_faction, "trp_knight_2_4", "fac_kingdom_10"),
	  (troop_set_faction, "trp_knight_2_16", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_2_19", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_3_4", "fac_kingdom_11"),
	  
	  (troop_set_faction, "trp_knight_mod_5", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_mod_6", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_mod_7", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_mod_8", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_mod_9", "fac_kingdom_7"),
	  (troop_set_faction, "trp_knight_mod_10", "fac_kingdom_8"),
	  (troop_set_faction, "trp_knight_mod_11", "fac_kingdom_8"),
	  (troop_set_faction, "trp_knight_mod_12", "fac_kingdom_2"),
	  (troop_set_faction, "trp_knight_mod_13", "fac_kingdom_9"),
	  (troop_set_faction, "trp_knight_mod_14", "fac_kingdom_9"),
	  (troop_set_faction, "trp_knight_mod_15", "fac_kingdom_9"),
	  (troop_set_faction, "trp_knight_mod_16", "fac_kingdom_9"),
	  (troop_set_faction, "trp_knight_mod_17", "fac_kingdom_9"),
	  (troop_set_faction, "trp_knight_mod_18", "fac_kingdom_10"),
	  (troop_set_faction, "trp_knight_mod_19", "fac_kingdom_10"),
	  (troop_set_faction, "trp_knight_mod_20", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_mod_21", "fac_kingdom_12"),
	  (troop_set_faction, "trp_knight_mod_22", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_mod_23", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_mod_24", "fac_kingdom_11"),
	  (troop_set_faction, "trp_knight_mod_25", "fac_kingdom_12"),
	  (troop_set_faction, "trp_knight_mod_26", "fac_kingdom_12"),
	  (troop_set_faction, "trp_knight_mod_27", "fac_kingdom_12"),
	  (troop_set_faction, "trp_knight_mod_28", "fac_kingdom_12"),
	  
	  (faction_set_slot, "fac_kingdom_7",  slot_faction_culture, "fac_culture_3"),
      (faction_set_slot, "fac_kingdom_7",  slot_faction_leader, "trp_knight_mod_1"),
	  (troop_set_slot, "trp_knight_mod_1", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_1", "fac_kingdom_7"),
	  (troop_set_slot, "trp_knight_mod_1", slot_troop_is_king, "fac_kingdom_7"),

      (faction_set_slot, "fac_kingdom_8",  slot_faction_culture, "fac_culture_1"),
      (faction_set_slot, "fac_kingdom_8",  slot_faction_leader, "trp_knight_mod_2"),
	  (troop_set_slot, "trp_knight_mod_2", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_2", "fac_kingdom_8"),
	  (troop_set_slot, "trp_knight_mod_2", slot_troop_is_king, "fac_kingdom_8"),

      (faction_set_slot, "fac_kingdom_9",  slot_faction_culture, "fac_culture_2"),
      (faction_set_slot, "fac_kingdom_9",  slot_faction_leader, "trp_knight_mod_3"),
	  (troop_set_slot, "trp_knight_mod_3", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_3", "fac_kingdom_9"),
	  (troop_set_slot, "trp_knight_mod_3", slot_troop_is_king, "fac_kingdom_9"),

      (faction_set_slot, "fac_kingdom_10",  slot_faction_culture, "fac_culture_6"),
      (faction_set_slot, "fac_kingdom_10",  slot_faction_leader, "trp_knight_mod_4"),
	  (troop_set_slot, "trp_knight_mod_4", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_4", "fac_kingdom_10"),
	  (troop_set_slot, "trp_knight_mod_4", slot_troop_is_king, "fac_kingdom_10"),
	  
	  (faction_set_slot, "fac_kingdom_11",  slot_faction_culture, "fac_culture_1"),
      (faction_set_slot, "fac_kingdom_11",  slot_faction_leader, "trp_knight_mod_20"),
	  (troop_set_slot, "trp_knight_mod_20", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_20", "fac_kingdom_11"),
	  (troop_set_slot, "trp_knight_mod_20", slot_troop_is_king, "fac_kingdom_11"),
	  
	  (faction_set_slot, "fac_kingdom_12",  slot_faction_culture, "fac_culture_6"),
      (faction_set_slot, "fac_kingdom_12",  slot_faction_leader, "trp_knight_mod_21"),
	  (troop_set_slot, "trp_knight_mod_21", slot_troop_renown, 1200),
	  (troop_set_faction, "trp_knight_mod_21", "fac_kingdom_12"),
	  (troop_set_slot, "trp_knight_mod_21", slot_troop_is_king, "fac_kingdom_12"),
	  
	  (try_for_range, ":troop_id", kings_begin, kingdom_ladies_end),
		(troop_get_slot, ":troop_adult_year", ":troop_id", slot_troop_adult_year),
		(try_begin),
			(ge, ":troop_adult_year", 190),
			# (store_faction_of_troop, ":faction_id", ":troop_id"),
			# (troop_set_slot, ":troop_id", slot_troop_born_faction, ":faction_id"), 
			# (troop_set_faction, ":troop_id", "fac_unborn"),
			(troop_get_slot, ":troop_id_2", ":troop_id", slot_troop_spouse),
			# (troop_set_slot, ":troop_id", slot_troop_spouse, -1), 
			# (troop_get_slot, ":troop_father", ":troop_id", slot_troop_father), 
			# (troop_get_slot, ":troop_guardian", ":troop_id", slot_troop_guardian), 
			
			# (troop_set_slot, ":troop_id", slot_troop_born_father, ":troop_father"), 
			# (troop_set_slot, ":troop_id", slot_troop_born_guardian, ":troop_guardian"), 
			# (troop_set_slot, ":troop_id", slot_troop_father, -1), 
			# (troop_set_slot, ":troop_id", slot_troop_guardian, -1), 
			(try_begin),
				(neq, ":troop_id_2", -1),
				(troop_get_type, ":is_female", ":troop_id_2"),
				(eq, ":is_female", 1),
				(gt, ":troop_id_2", 0),
				(troop_set_slot, ":troop_id_2", slot_troop_spouse, -1), 
				(call_script, "script_get_kingdom_lady_social_determinants", ":troop_id_2"),
				(try_begin),
					(eq, reg0, ":troop_id_2"),
					(call_script, "script_remove_troop_to_unborn", ":troop_id_2"),
				(try_end),
			(try_end),
			(call_script, "script_remove_troop_to_unborn", ":troop_id"),
			(try_for_range, ":troop_id_son", kings_begin, kingdom_ladies_end),
				(troop_get_slot, ":troop_father", ":troop_id_son", slot_troop_father), 
				(troop_get_slot, ":troop_guardian", ":troop_id_son", slot_troop_guardian), 
				(this_or_next|eq, ":troop_father", ":troop_id"),
				(eq, ":troop_guardian", ":troop_id"),
				(call_script, "script_remove_troop_to_unborn", ":troop_id_son"),
			(try_end),
		(try_end),
		(troop_get_slot, ":troop_dead_year", ":troop_id", slot_troop_dead_year),
		(try_begin),
			(lt, ":troop_dead_year", 190),
			(troop_set_faction, ":troop_id", "fac_undeads"),
			(troop_get_slot, ":troop_id_2", ":troop_id", slot_troop_spouse),
			(troop_set_slot, ":troop_id", slot_troop_spouse, -1), 
			(try_begin),
				(gt, ":troop_id_2", 0),
				...
				(try_begin),
					(eq, reg0, ":troop_id_2"),
					(call_script, "script_remove_troop_to_undeads", ":troop_id_2"),
				(try_end),
			(try_end),
			(call_script, "script_remove_troop_to_undeads", ":troop_id"),
		(try_end),
      (try_end),
	  # (store_troop_faction, reg0, "trp_player"),
	  # (display_message, "@TU,{reg0}"),
	  
	  (faction_set_slot, "fac_kingdom_1", slot_faction_banner, "mesh_banner_new_kingdom_a"),
      (faction_set_slot, "fac_kingdom_2", slot_faction_banner, "mesh_banner_new_kingdom_b"),
      (faction_set_slot, "fac_kingdom_3", slot_faction_banner, "mesh_banner_new_kingdom_c"),
      (faction_set_slot, "fac_kingdom_4", slot_faction_banner, "mesh_banner_new_kingdom_d"),
      (faction_set_slot, "fac_kingdom_5", slot_faction_banner, "mesh_banner_new_kingdom_e"),
      (faction_set_slot, "fac_kingdom_6", slot_faction_banner, "mesh_banner_new_kingdom_f"),
      (faction_set_slot, "fac_kingdom_7", slot_faction_banner, "mesh_banner_new_kingdom_g"),
      (faction_set_slot, "fac_kingdom_8", slot_faction_banner, "mesh_banner_new_kingdom_h"),
      (faction_set_slot, "fac_kingdom_9", slot_faction_banner, "mesh_banner_new_kingdom_i"),
      (faction_set_slot, "fac_kingdom_10", slot_faction_banner, "mesh_banner_new_kingdom_j"),
      (faction_set_slot, "fac_kingdom_11", slot_faction_banner, "mesh_banner_new_kingdom_k"),
      (faction_set_slot, "fac_kingdom_12", slot_faction_banner, "mesh_banner_new_kingdom_l"),
      ...
      # (faction_set_slot, "fac_kingdom_10", slot_faction_banner, "mesh_banner_kingdom_d"),
	  ...
	  (try_for_range, ":cur_faction", npc_kingdoms_begin, npc_kingdoms_end),
        ...
        # (val_sub, ":cur_faction_banner", "mesh_banner_new_kingdom_a"),
        # (val_add, ":cur_faction_banner", "spr_banner_new_kingdom_a"),
		...
		(troop_get_slot, ":cur_party", ":cur_faction_king", slot_troop_leaded_party),
		(gt, ":cur_party", 0),
		(party_set_banner_icon, ":cur_party", ":cur_faction_banner"),   
		(try_for_range, ":cur_center", walled_centers_begin, walled_centers_end),
			(party_slot_eq, ":cur_center", slot_town_lord, ":cur_faction_king"),
			(val_sub, ":cur_faction_banner", banner_scene_props_begin),
			(val_add, ":cur_faction_banner", banner_map_icons_begin),
			(party_set_banner_icon, ":cur_center", ":cur_faction_banner"), 
		(try_end),
      (try_end),
...
# We assume there are enough banners for all kingdom heroes.
	  ...
	  (call_script, "script_give_center_to_faction_aux", "p_town_3", "fac_neutral_new"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_4", "fac_kingdom_11"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_5", "fac_neutral_new"),
	  ...
	  (call_script, "script_give_center_to_faction_aux", "p_town_8", "fac_kingdom_9"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_9", "fac_kingdom_9"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_10", "fac_kingdom_3"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_11", "fac_kingdom_5"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_12", "fac_kingdom_4"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_13", "fac_kingdom_6"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_14", "fac_kingdom_8"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_15", "fac_neutral_new"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_16", "fac_kingdom_12"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_17", "fac_neutral_new"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_18", "fac_kingdom_7"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_19", "fac_kingdom_10"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_20", "fac_kingdom_12"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_21", "fac_neutral_new"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_22", "fac_kingdom_3"),
	  (call_script, "script_give_center_to_faction_aux", "p_town_23", "fac_kingdom_5"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_3", "fac_kingdom_4"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_6", "fac_kingdom_9"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_7", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_8", "fac_kingdom_9"),
      # (call_script, "script_give_center_to_faction_aux", "p_castle_9", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_10", "fac_kingdom_6"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_14", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_15", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_16", "fac_kingdom_4"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_19", "fac_kingdom_9"),
      # (call_script, "script_give_center_to_faction_aux", "p_castle_20", "fac_neutral_new"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_23", "fac_kingdom_11"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_24", "fac_kingdom_1"),

      (call_script, "script_give_center_to_faction_aux", "p_castle_25", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_26", "fac_kingdom_12"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_27", "fac_kingdom_1"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_28", "fac_neutral_new"),

      (call_script, "script_give_center_to_faction_aux", "p_castle_29", "fac_neutral_new"), 
      (call_script, "script_give_center_to_faction_aux", "p_castle_30", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_31", "fac_kingdom_6"),

      (call_script, "script_give_center_to_faction_aux", "p_castle_32", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_33", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_34", "fac_kingdom_7"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_35", "fac_kingdom_6"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_38", "fac_kingdom_8"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_39", "fac_kingdom_11"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_40", "fac_kingdom_9"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_43", "fac_kingdom_10"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_48", "fac_kingdom_4"),
      
      (call_script, "script_give_center_to_faction_aux", "p_castle_49", "fac_kingdom_5"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_50", "fac_kingdom_3"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_51", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_52", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_53", "fac_neutral_new"),
      ...
      (call_script, "script_give_center_to_faction_aux", "p_castle_56", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_57", "fac_kingdom_6"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_58", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_59", "fac_neutral_new"),
      # (call_script, "script_give_center_to_faction_aux", "p_castle_60", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_61", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_62", "fac_neutral_new"),
      # (call_script, "script_give_center_to_faction_aux", "p_castle_63", "fac_neutral_new"),
      (call_script, "script_give_center_to_faction_aux", "p_castle_64", "fac_neutral_new"),
	  
	  
	  # (call_script, "script_give_center_to_lord", "p_town_1",  "trp_kingdom_4_lord", 0),
      # # (call_script, "script_give_center_to_lord", "p_town_2",  "trp_knight_1_5", 0),
      # # (call_script, "script_give_center_to_lord", "p_town_3",  "trp_knight_5_1", 0),
      # (call_script, "script_give_center_to_lord", "p_town_4",  "trp_knight_mod_20", 0),
      # # (call_script, "script_give_center_to_lord", "p_town_5",  "trp_kingdom_5_lord", 0),
      # (call_script, "script_give_center_to_lord", "p_town_6",  "trp_kingdom_6_lord", 0),
      # (call_script, "script_give_center_to_lord", "p_town_7",  "trp_kingdom_1_lord", 0),
      
      # (call_script, "script_give_center_to_lord", "p_town_8",  "trp_knight_mod_3", 0),
      # (call_script, "script_give_center_to_lord", "p_town_9",  "trp_knight_mod_14", 0),
      # (call_script, "script_give_center_to_lord", "p_town_10", "trp_knight_3_1", 0),
      # (call_script, "script_give_center_to_lord", "p_town_11", "trp_knight_5_19", 0),
      # (call_script, "script_give_center_to_lord", "p_town_12", "trp_knight_4_3", 0),
      # (call_script, "script_give_center_to_lord", "p_town_13", "trp_knight_6_9", 0),
      # (call_script, "script_give_center_to_lord", "p_town_14", "trp_knight_mod_2", 0),

      # # (call_script, "script_give_center_to_lord", "p_town_15", "trp_knight_3_1", 0),
      # (call_script, "script_give_center_to_lord", "p_town_16", "trp_knight_mod_25", 0), #changed from 1_3
      # # (call_script, "script_give_center_to_lord", "p_town_17", "trp_knight_3_2", 0),
      # (call_script, "script_give_center_to_lord", "p_town_18", "trp_knight_mod_1", 0),	  
	  
      # (call_script, "script_give_center_to_lord", "p_town_19", "trp_knight_mod_4", 0),
      # (call_script, "script_give_center_to_lord", "p_town_20", "trp_knight_mod_21", 0), 
      # # (call_script, "script_give_center_to_lord", "p_town_21", "trp_knight_2_4", 0),
      # (call_script, "script_give_center_to_lord", "p_town_22", "trp_kingdom_3_lord", 0),	  

      # # Give family castles to certain nobles.
	  # (call_script, "script_give_center_to_lord", "p_castle_1", "trp_knight_5_4", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_2", "trp_knight_1_5", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_4", "trp_knight_6_5", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_6", "trp_knight_mod_17", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_8", "trp_knight_mod_15", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_10", "trp_knight_6_10", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_11", "trp_knight_6_12", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_12", "trp_knight_3_8", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_13", "trp_knight_6_2", 0),
	  # (call_script, "script_give_center_to_lord", "p_castle_16", "trp_knight_4_2", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_17", "trp_knight_1_3", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_18", "trp_knight_6_3", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_19", "trp_knight_mod_13", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_23", "trp_knight_mod_22", 0), #Nelag_Castle
	  # # (call_script, "script_give_center_to_lord", "p_castle_21", "trp_kingdom_5_lord", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_22", "trp_kingdom_2_lord", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_24", "trp_knight_1_9", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_26", "trp_knight_mod_26", 0), #Nelag_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_27", "trp_knight_1_1", 0), #Nelag_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_29", "trp_knight_6_10", 0), #Nelag_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_30", "trp_knight_3_4", 0), #Asugan_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_31", "trp_knight_6_6", 0), #Asugan_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_32", "trp_knight_2_3", 0), #Asugan_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_34", "trp_knight_mod_5", 0), #Asugan_Castle
      # (call_script, "script_give_center_to_lord", "p_castle_35", "trp_knight_6_4", 0), #Haringoth_Castle
      # (call_script, "script_give_center_to_lord", "p_castle_36", "trp_knight_mod_8", 0), #Haringoth_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_37", "trp_knight_6_13", 0), #Haringoth_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_38", "trp_knight_5_11", 0), #Haringoth_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_39", "trp_knight_2_19", 0), #Haringoth_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_42", "trp_knight_6_7", 0), #Haringoth_Castle
	  # (call_script, "script_give_center_to_lord", "p_castle_43", "trp_knight_mod_19", 0), #Haringoth_Castle
      
      # (call_script, "script_give_center_to_lord", "p_castle_49", "trp_knight_5_20", 0), #Deglan_Castle
      # (call_script, "script_give_center_to_lord", "p_castle_50", "trp_knight_3_2", 0), #Tredian_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_51", "trp_knight_5_7", 0), #Grainwad_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_52", "trp_knight_3_8", 0), #Ryis_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_53", "trp_knight_3_11", 0), #Stamar_Castle
      
      # (call_script, "script_give_center_to_lord", "p_castle_54", "trp_knight_mod_16", 0), #Doru_Castle
      # # # (call_script, "script_give_center_to_lord", "p_castle_55", "trp_knight_6_15", 0), #Gastya_Castle
      
      # # (call_script, "script_give_center_to_lord", "p_castle_56", "trp_knight_5_10", 0), #Sebula_Castle
      
      # # (call_script, "script_give_center_to_lord", "p_castle_57", "trp_knight_6_12", 0), #Turegor_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_58", "trp_knight_3_15", 0), #Rayeck_Castle
      
      # # (call_script, "script_give_center_to_lord", "p_castle_59", "trp_knight_4_5", 0), #Reland_Castle
      ...
      # # (call_script, "script_give_center_to_lord", "p_castle_62", "trp_knight_2_11", 0), #Ghulassen_Castle
      # # # (call_script, "script_give_center_to_lord", "p_castle_63", "trp_knight_5_15", 0), #Muhnir_Castle
      # # (call_script, "script_give_center_to_lord", "p_castle_64", "trp_knight_4_19", 0), #Biliya_Castle
	  (try_for_range, ":center", centers_begin, centers_end),
		(party_set_slot, ":center", slot_town_lord, -1),
	  (try_end),
	  (call_script, "script_give_center_to_lord", "p_town_22", "trp_kingdom_3_lord", 0),
	  (call_script, "script_give_center_to_lord", "p_castle_22", "trp_kingdom_2_lord", 0),
	  (call_script, "script_give_center_to_lord", "p_town_18", "trp_knight_mod_1", 0),
	  (call_script, "script_give_center_to_lord", "p_town_14", "trp_knight_mod_2", 0),
	  (call_script, "script_give_center_to_lord", "p_town_4",  "trp_knight_mod_20", 0),
	  (call_script, "script_give_center_to_lord", "p_town_7",  "trp_kingdom_1_lord", 0),
	  ...
	  (call_script, "script_give_center_to_lord", "p_town_8",  "trp_knight_mod_3", 0),
	  # (call_script,"script_set_town_lord"),
	  ...
	  # (party_set_slot, "p_castle_19", slot_center_ex_faction, "fac_kingdom_2"), #vaegirs claim nord-held alburq
	  # (party_set_slot, "p_castle_26", slot_center_ex_faction, "fac_kingdom_4"), #nords claim swadian-held kelredan
	  # (party_set_slot, "p_castle_35", slot_center_ex_faction, "fac_kingdom_1"), #swadians claim rhodok-held ergelon
	  # (party_set_slot, "p_town_3",    slot_center_ex_faction, "fac_kingdom_5"), #rhodoks claim sarranid-held weyyah
	  # (party_set_slot, "p_town_13",   slot_center_ex_faction, "fac_kingdom_6"), #sarranids claim khergit-held uhhun
	  # (party_set_slot, "p_town_10",   slot_center_ex_faction, "fac_kingdom_3"), #Khergits claim vaegir-held curaw
	  ...
	  (try_for_range, ":cur_kingdom", "fac_kingdom_1", kingdoms_end),
		(try_for_range, ":cur_kingdom_2", "fac_kingdom_1", kingdoms_end),
			(neq, ":cur_kingdom", ":cur_kingdom_2"),
			(store_add, ":slot_no", ":cur_kingdom_2", slot_faction_truce_days_with_factions_begin),
			(val_sub, ":slot_no", kingdoms_begin),
			(faction_set_slot, ":cur_kingdom", ":slot_no", 0),
			(val_add, ":slot_no", 40),
			(faction_set_slot, ":cur_kingdom", ":slot_no", 0),
			(val_add, ":slot_no", 40),
			(faction_set_slot, ":cur_kingdom", ":slot_no", 0),
		(try_end),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_1"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_2", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 25),
	  (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_2"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_2"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 75),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		(try_begin),
			(gt, ":relation", 75),
			(store_sub, ":relation", 150, ":relation"),
		(try_end),
		(val_mul, ":relation", 100),
		(val_div, ":relation", 75),
		(store_sub, ":relation", 100, ":relation"),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
	  (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_3", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 75),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_3"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_3"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 101),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_4", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 101),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_4"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_4"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 45),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_5", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 45),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_5"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_5"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 126),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_6", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 126),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_6"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_6"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 1),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_7", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 1),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_7"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_7"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 65),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_8", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 65),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_8"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_8"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 43),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_9", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 43),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_9"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_9"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 55),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_10", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 55),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_10"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_10"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 70),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_11", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 70),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_11"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_11"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 82),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
		...
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", ":relation"),
      (try_end),
	  (try_for_range, ":cur_kingdom_2", "fac_kingdom_12", kingdoms_end),
		(set_relation, ":cur_kingdom", ":cur_kingdom_2", 82),
      (try_end),
	  (assign, ":cur_kingdom", "fac_kingdom_12"),
      (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", "fac_kingdom_12"),
		(store_relation, ":relation", ":cur_kingdom", ":cur_kingdom_2"),
		(assign, ":random", 140),
		(val_sub, ":relation", ":random"),
		(val_abs, ":relation"),
	  ...
	  # (assign, ":cur_kingdom", "fac_kingdom_6"),
	  # (try_for_range, ":cur_kingdom_2", "fac_kingdom_1", kingdoms_end),
		# (store_random_in_range, ":random", -30, -10),
		# (set_relation, ":cur_kingdom", ":cur_kingdom_2", ":random"),
      # (try_end),
	  ...
	  (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),#add town garrisons
        ...
        (try_end),
		(try_begin),
			(eq, ":center_no", "p_castle_31"),
			(assign, ":garrison_strength", 80), 
			(assign, ":initial_wealth", 10000),
		(try_end),
        (try_for_range, ":unused", 0, ":garrison_strength"),
          (call_script, "script_cf_reinforce_party", ":center_no"),
        (try_end),
...
######### gm ####### jiaolian ##### TU ####
		 # (assign, "$g_starting_faction", "fac_kingdom_1"),
################
...
####### game_mens ###### TU ######## neizheng ########### 8.4 #####################
      ("city_management",
	   [
		(assign, ":player_have_center", 0),
		(try_for_range, ":center_no", walled_centers_begin, walled_centers_end),
			(party_get_slot, ":center_lord", ":center_no", slot_town_lord),
			(try_begin),
				(eq, ":center_lord", "trp_player"),
				(assign, ":player_have_center", 1),
			(try_end),
		(try_end),
		(eq, ":player_have_center", 1),
	   ],"City management",
       [(start_presentation, "prsnt_neizheng_center_2"),
        ]
       ),
###########################################################
  ...
  ("start_game_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
      ...
      ("quick_start",[], "Quick start...",
       [
		(assign, "$cheat_mode", 1),
		(party_add_members, 0, "trp_vaegir_guard", 100),
		(troop_add_gold, 0, 5000),
		(change_screen_map),
       ]),
    ]
  ),
...
##        (troop_raise_proficiency, "trp_player",2,20),
    ...
    (else_try),
        ...
        (troop_add_item, "trp_player","itm_bolts",0),
        (troop_add_item, "trp_player","itm_courser", imod_spirited),
        (troop_add_item, "trp_player","itm_wushuang_bin01_gongsun_head",imod_sturdy),
...
############ game_menu ######## juewei ######## TU ##### "character_report" ######
	(call_script, "script_get_the_title", "trp_player"),
#############################	
...
## fy ###### TU ##
  ...
  [
    ...
    [
	  ("camp_action_0",[(eq, "$cheat_fysg", 1),],"zuobi",
       [
	    (val_add, "$cheat_mode", 1),
		(val_mod, "$cheat_mode", 2),
		# (troop_set_slot, "trp_player", slot_troop_jineng, wuzhongshengyou),
		(troop_set_slot, "trp_player", slot_troop_jinengdian, 10),
		# (troop_set_slot, "trp_kingdom_1_lord", slot_troop_jineng, kongchengji),
		# (troop_set_slot, "trp_kingdom_1_lord", slot_troop_jinengdian, 100),
		# (party_set_slot, "p_town_1", slot_party_jineng_kongchengji_flag, 1),
		# (store_current_hours, ":current_hours"),
		# (party_set_slot, "p_town_1", slot_party_jineng_kongchengji_begin, ":current_hours"),
		# (troop_get_slot, ":party_no", "trp_knight_2_1", slot_troop_leaded_party),
		# (change_screen_exchange_members, 1, ":party_no"),
		# (party_get_num_companion_stacks, ":num_stacks", "p_main_party"),   
		# (try_for_range, ":cur_stack", 0, ":num_stacks"),
			# (party_stack_get_troop_id, ":cur_troop", "p_main_party", ":cur_stack"),
			# (remove_member_from_party, ":cur_troop", "p_main_party"),
		# (try_end),
		# (troop_get_slot, reg0, "trp_player", slot_troop_is_king),
		# (display_message, "@TU,{reg0}"),
		# (party_get_num_companion_stacks, ":num_stacks", "p_main_party"),   
		# (try_for_range, reg0, 0, ":num_stacks"),
			# (party_stack_get_troop_id, ":cur_troop", "p_main_party", 0),
			# (str_store_troop_name, s2, ":cur_troop"),
			# (display_message, "@{s2}"),
			# (party_stack_get_size, ":stack_size", "p_main_party", 0),
			# (party_remove_members, "p_main_party", ":cur_troop", ":stack_size"), 
		...
		# (try_for_range, reg0, 0, ":num_stacks"),
			# (party_stack_get_troop_id, ":cur_troop", "p_temp_party", 0),
			# (party_stack_get_size, ":stack_size", "p_temp_party", 0),
			# (party_remove_members, "p_temp_party", ":cur_troop", ":stack_size"), 
		# (try_end),
		# (party_stack_get_troop_id, reg0, "p_temp_party", 0),
		# (display_message, "@TU,{reg0}"),
		# (call_script, "script_change_party_member", 0, "p_town_1"), TU 7.4
       ]
       ),
      ...
      ("camp_action_1",[(eq,"$cheat_mode",1)],"{!}Cheat: Walk around.",
       [
	    (set_jump_mission,"mt_ai_training"),
        (modify_visitors_at_site, "scn_village_200"),
        (reset_visitors),
        (set_visitor,0,"trp_player"),
...
######## TU ###### 13.2.1 ### jineng ###	   
      ("camp_jineng",[(troop_slot_ge, "trp_player", slot_troop_jineng, 1),],"jineng",
       [(jump_to_menu, "mnu_jineng_menu"),
        ]),
########################
      ...
      #add by dark night
	    ...
	    [(start_presentation, "prsnt_camp_mod_opition")
	      ]
	     ),
	    #add by dark night end
...
#####################################################
      #my_mod  	TU
      ("partition_troops",[],"Partition troop",
       [(jump_to_menu, "mnu_troops_prepare"),
        ]
       ),
###########################################################
      ...
      ("camp_cheat",
       [(this_or_next|ge, "$cheat_mode", 1),(eq, "$cheat_box_val", 1),
        ], "CHEAT MENU!",
   ...
   [
	...
	(else_try),
	  (eq,"$g_duel_troop","trp_chuyun"),
		(check_quest_failed, "qst_duel_chuyun"),
        (str_store_string, s11, "str_you_lie_stunned_for_several_minutes_then_stagger_to_your_feet_to_find_your_s10_standing_over_you_you_have_lost_the_duel"),
    (else_try),
		(eq,"$g_duel_troop","trp_chuyun"),
		(check_quest_succeeded, "qst_duel_chuyun"),
        (str_store_string, s11, "str_s10_lies_in_the_arenas_dust_for_several_minutes_then_staggers_to_his_feet_you_have_won_the_duel"),
    # add end
	(else_try),
...
############  arena_duel_conclusion  #####  gm  ####  gaitoukui  ## TU ##########
		(try_begin),
			(troop_get_inventory_slot, ":item_id", "$g_duel_troop", ek_head),
			(neq,":item_id","itm_toumingtou"),
			(mission_tpl_entry_set_override_flags, "mt_conversation_encounter", 17, af_override_fullhelm),	
		(try_end),
#######################
...
############################### Duel Mod Start by Dark night ############################## 
 ...
 (str_clear, s2),  (str_clear, s3), (str_clear, s5), (str_clear, s6), (str_clear, s7), 
   ...
   (str_store_troop_name, s3, "$g_talk_troop"), 
 	 (try_begin), 
 	 	 (eq, "$g_duel_result", -1), 
 	 	 (str_store_string, s1, "str_last_duel_lost"), 
 	 (else_try), 
 	 	 (eq, "$g_duel_result", 1), 
 	 	 (str_store_string, s1, "str_last_duel_win"), 
 	 (else_try), 
 	 	 (str_store_string, s1, "str_last_duel_no"), 
 	 (try_end), 
    (try_begin), 
 	 	 (troop_is_hero, "$g_talk_troop"), 
 	 	 (str_store_string, s2, "str_duel_with_hero"), 
 	 (else_try), 
 	 	 (str_store_string, s2, "str_duel_with_troop"), 
 	 (try_end), 
  ...
  (
    ...
    [      
		...
		(try_begin),
			...
			(troop_get_slot, ":party_no", "$jineng_zouweishang_troop", slot_troop_leaded_party),
			(set_fixed_point_multiplier, 100),
			
			(assign, ":min_dist", 999999),
			(assign, ":min_dist_village", -1),
			(try_for_range, ":cur_village", centers_begin, centers_end),
				(store_distance_to_party_from_party, ":cur_dist", ":cur_village", ":party_no"),
				(lt, ":cur_dist", ":min_dist"),
				(assign, ":min_dist", ":cur_dist"),
				(assign, ":min_dist_village", ":cur_village"),
			(try_end),

			(party_get_position, pos1, ":min_dist_village"),
			(party_set_position, ":party_no", pos1),
			(assign, "$jineng_zouweishang_troop", -1),
			(leave_encounter),
			(change_screen_return),
		(try_end),
		############################
...
#          (try_end),
    ...
    [ 
      #add by dark night
      ("encounter_change_controller",
      [
        (str_store_troop_name,s5,"$g_player_troop"),
      ],
      "Charge the controller(Controller:{s5}).",
      [
       (assign, "$g_change_controller_num", 0),
       (jump_to_menu, "mnu_encounter_change_controller"),
      ]),
      #add by dark night end
	  jineng_menu_battle,#TU 6.24
...
######## TU ####### 13.1.31 #### jineng ####		
	  ("encounter_jineng_zouweishang",[
        ...
        (try_for_range, ":cur_stack", 0, ":num_stacks"),
			...
			(troop_get_slot, ":jineng_no", ":cur_troop", slot_troop_jineng),
			(troop_get_slot, ":jinengdian", ":cur_troop", slot_troop_jinengdian),
			(eq, ":jineng_no", zouweishang),
			(ge, ":jinengdian", 5),
			(assign, ":num_stacks", 0),
			(assign, ":continue", 1),
			(assign, "$zouweishang_troop", ":cur_troop"),
        (try_end),
		(eq, ":continue", 1),
        ],"zouweishang",
		[
		(troop_get_slot, ":jinengdian", "$zouweishang_troop", slot_troop_jinengdian),
		(val_sub, ":jinengdian", 5),
		(troop_set_slot, "$zouweishang_troop", slot_troop_jinengdian, ":jinengdian"),
		(leave_encounter),
		(change_screen_return)]),
####################
    ]
  ...
  (
    ...
    (try_end),
     ...
     (try_begin),
       ...
       (try_begin),
         (lt, "$g_player_end_hp", "$g_player_begin_hp"),
         (troop_set_health, "trp_player", "$g_player_begin_hp"),
       (try_end),  
       (assign, "$g_player_troop", "trp_player"),
       (set_player_troop, "$g_player_troop"),
     (try_end),
  ...
  (
    ...
    [
        ...
        (try_begin),
          ...
          (try_end),
		  (neq, "$freelancer_state", 1),#TU jineng_xiaobing
...
########## gm ######### TU #### suijun ## "total_victory" #############
		  (try_begin),
			# (main_party_has_troop,"trp_npc2"),
			# (troop_is_wounded,"trp_npc2"),
			#(check_quest_active, "qst_find_stone"),
			(eq, "$save_merchant", 1),
			(jump_to_menu, "mnu_suijun_loot"),
		  (else_try),
		    (change_screen_loot, "trp_temp_troop"),
		  (try_end),
#######################
        (else_try),
          ...
          (try_begin),
            ...
            (change_screen_return),
          (else_try),            
			(eq,  "$freelancer_state", 0),#TU jineng_xiaobing
...
##            (eq, ":random_attribute", ca_intelligence),
  ...
  (
    ...
    [
      ...
      ]+ pre_join_freelancer,#TU jineng_xiaobing
    [
  ...
  (
    ...
    [
      ...
      "Charge the controller(Controller:{s5}).",
      [
       (assign, "$g_change_controller_num", 1),
       (jump_to_menu, "mnu_encounter_change_controller"),
      ]),
      #add by dark night end    
	  jineng_menu_battle,#TU 6.24
      ...
      ("join_leave",[(neq, "$freelancer_state", 1)],"Leave.",#TU jineng_xiaobing
      [
        (try_begin),
           (neg|troop_is_wounded, "$g_player_troop"),
           (call_script, "script_objectionable_action", tmt_aristocratic, "str_flee_battle"),
        ...
        (leave_encounter),(change_screen_return)]),
      ] + join_wounded_freelancer),#TU jineng_xiaobing
...
##  ),
  ...
  (
    ...
    [
        ...
        (try_end),
    ]+ join_siege_outside_freelancer,#TU jineng_xiaobing
    [
...
##          (jump_to_menu, "mnu_total_victory"),
    ...
    [
      ("talk_to_siege_commander",[],"Request a meeting with the commander.",[
                                ...
                                (set_jump_mission,"mt_conversation_encounter"),
								############  talk_to_siege_commander  #####  gm  ####  gaitoukui  ## TU ##########
								(try_begin),
									(troop_get_inventory_slot, ":item_id", ":siege_leader_id", ek_head),
									(neq,":item_id","itm_toumingtou"),
									(mission_tpl_entry_set_override_flags, "mt_conversation_encounter", 17, af_override_fullhelm),		
								(try_end),
						        #######################
      ...
      "Charge the controller(Controller:{s5}).",
      [
       (assign, "$g_change_controller_num", 2),
       (jump_to_menu, "mnu_encounter_change_controller"),
      ]),
      #add by dark night end     
	  jineng_menu_battle,#TU 6.24
...
########### gm ###### chongche ###### join_siege_with_allies #### TU ##########
			(else_try),
			  (party_slot_eq, "$g_encountered_party", slot_center_siege_with_belfry, 2),
              (set_jump_mission,"mt_castle_attack_walls_chongche"),
##########################################
########### gm ###### chuan ###### join_siege_with_allies #### TU ##########
			(else_try),
			  (party_slot_eq, "$g_encountered_party", slot_center_siege_with_belfry, 3),
              (set_jump_mission,"mt_castle_attack_walls_ship"),
##########################################
           (else_try),
      ...
      ("join_siege_stay_back", [(neq, "$freelancer_state", 1),#TU jineng_xiaobing
								(call_script, "script_party_count_members_with_full_health", "p_main_party"),
                                (ge, reg0, 3),
                                ],
      ...
      ("leave",[(neq, "$freelancer_state", 1),],"Leave.",[(leave_encounter),(change_screen_return)]),#TU jineng_xiaobing
    ] + join_wounded_freelancer#TU jineng_xiaobing
  ),
...
#          (str_store_string, s3, "str_place_is_occupied_by_friendly"),
        ...
        (else_try),
          ...
          (set_jump_mission, "mt_conversation_encounter"),
############  castle_outside  #####  gm  ####  gaitoukui  ## TU ##############
			(try_begin),
				(troop_get_inventory_slot, ":item_id", ":quest_object_troop", ek_head),
				(neq,":item_id","itm_toumingtou"),
				(mission_tpl_entry_set_override_flags, "mt_conversation_encounter", 17, af_override_fullhelm),		
			(try_end),
#######################
...
############  castle_outside  #####  gm  ####  gaitoukui  ## TU ###########
			(try_begin),
				(troop_get_inventory_slot, ":item_id", "trp_kidnapped_girl", ek_head),
				(neq,":item_id","itm_toumingtou"),
				(mission_tpl_entry_set_override_flags, "mt_conversation_encounter", 17, af_override_weapons),		
			(try_end),
#######################
          (assign, "$talk_context", tc_entering_center_quest_talk),
...
##          (change_screen_map_conversation, ":cur_lord"),
        ...
        (else_try),
		  ...
		  # (neq, "$g_encountered_party_faction", "fac_neutral"),		  #TU
...
##                                                   (change_screen_map_conversation, ":cur_guard")
      ...
      ("castle_start_siege",
       [
			...
			(assign, ":continue", 1),
			(try_begin),
				(party_get_slot, ":kongchengji_flag", "$g_encountered_party", slot_party_jineng_kongchengji_flag),#qwe
				(eq, ":kongchengji_flag", 1),
				(party_get_slot, ":time_end", "$g_encountered_party", slot_party_jineng_kongchengji_begin),
				(val_add, ":time_end", 24),
				(store_current_hours, ":current_hours"),
				(try_begin),
					(lt, ":current_hours", ":time_end"),
					(assign, ":continue", 0),
				(else_try),
					(party_set_slot, "$g_encountered_party", slot_party_jineng_kongchengji_flag, 0),
				(try_end),
			(try_end),
			(eq, ":continue", 1),
			#####################
    ...
    [
      ("continue",[],
       ...
       [(jump_to_menu, "mnu_castle_outside"),
        ...
        (set_jump_mission,"mt_conversation_encounter"),
############  castle_meeting_selected  #####  gm  ####  gaitoukui  ## TU ########
		(try_begin),
			(troop_get_inventory_slot, ":item_id", "$castle_meeting_selected_troop", ek_head),
			(neq,":item_id","itm_toumingtou"),
			(mission_tpl_entry_set_override_flags, "mt_conversation_encounter", 17, af_override_fullhelm),		
		(try_end),
#######################
   ...
   (
    ...
    [
        ...
        (else_try),
          ...
          # (jump_to_menu, "mnu_total_victory"),
          (jump_to_menu, "mnu_total_victory_2"),# TU 2014.1.10 ## fuluwujiang
        (else_try),
          (call_script, "script_party_count_members_with_full_health", "p_main_party"),
    ...
    [
      ...
      "Charge the controller(Controller:{s5}).",
      [
       (assign, "$g_change_controller_num", 3),
       (jump_to_menu, "mnu_encounter_change_controller"),
      ]),
      #add by dark night end    
	  jineng_menu_battle,#TU 6.24
	  
########### TU #### new_dantiao #### cheng_duel ###
		("one-on-one",[
		],
		"One-on-one",
		[
			...
			(try_begin),
				(gt, ":horse", -1),
				(jump_to_menu, "mnu_cheng_duel"),
			(else_try),
				(display_message, "str_have_horse"),
			(try_end),
		]),
######################
      ...
      ("castle_lead_attack",
       ...
       [
           ...
           (try_end),
			...
			(store_div, ":sub_defense", ":player_party_strength", 10),
			(party_get_slot, ":party_defense", "$g_encountered_party", slot_party_defense),
			(val_sub, ":party_defense",  ":sub_defense"),
			(val_max, ":party_defense", -50),
			(party_set_slot, "$g_encountered_party", slot_party_defense, ":party_defense"),
			#######################
           ...
           (else_try),
             ...
             (set_jump_mission,"mt_castle_attack_walls_belfry"),
########### gm ###### chongche ####### castle_lead_attack ### TU #############
			(else_try),
			  (party_slot_eq, "$current_town", slot_center_siege_with_belfry, 2),
              (set_jump_mission,"mt_castle_attack_walls_chongche"),
##########################################
########### gm ###### chuan ###### castle_lead_attack #### TU ##########
			(else_try),
			  (party_slot_eq, "$current_town", slot_center_siege_with_belfry, 3),
              (set_jump_mission,"mt_castle_attack_walls_ship"),
##########################################
           (else_try),
             (set_jump_mission,"mt_castle_attack_walls_ladder"),
...
###################### TU #### chongche ##### chuan ##
	  ("build_siege_chongche",[(party_slot_eq, "$current_town", slot_center_siege_with_belfry, 2),(eq, "$g_siege_method", 0)],
       # "Build a chongche.", [(jump_to_menu,"mnu_construct_siege_chongche")]),
       "Build a chongche.", [(start_presentation, "prsnt_construct_siege_chongche")]),
	   
	  ("build_siege_chuan",[(party_slot_eq, "$current_town", slot_center_siege_with_belfry, 3),(eq, "$g_siege_method", 0)],
       "Build a chuan.", [(jump_to_menu,"mnu_construct_siege_chuan")]),
#################################
...
# TODO: To use for the future:
 ...
 Now the attackers are pouring into the streets. IF you can defeat them, you can perhaps turn the tide and save the day."),
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (assign, "$g_battle_result", 0),
            (jump_to_menu, "$g_siege_final_menu"),
 ############# TU ######### 2014.1.10 ### chongche ###
		  (else_try),
            (eq, "$g_siege_battle_state", 5),
            (eq, ":result", 1),
            (str_store_string, s1, "@You've breached2"),
 ############################
          (else_try),
 ...
 It must fall before you can complete your victory."),
        ...
        (else_try),
          ...
          (try_end),
        (try_end),
################ TU ############# "castle_besiege_inner_battle" ############
		   (try_begin),
				(eq, "$g_siege_battle_state", 1),
				(this_or_next|eq,"$g_encountered_party","p_town_1"),
				(this_or_next|eq,"$g_encountered_party","p_town_2"),
				(this_or_next|eq,"$g_encountered_party","p_town_5"),
				# (this_or_next|eq,"$g_encountered_party","p_town_6"),
...
############# TU ######### 2014.1.10 ### chongche ###
			   ...
			   (assign, ":battle_scene", "scn_chengmen_battle"),
			   (set_jump_mission, "mt_castle_attack_walls_ladder_2"),
             (else_try),
               (eq, "$g_siege_battle_state", 1),
               (party_get_slot, ":battle_scene", "$g_encountered_party", slot_town_center),
               (set_jump_mission, "mt_besiege_inner_battle_town_center_2"),#TU 2014.1.10
             (else_try),
			   (call_script, "script_set_random_fuluwujiang"),
    ...
    [
      ("build_ladders_cont",[],
       "Do it.", [
		   ...
		   (party_get_slot, ":party_defense", "$current_town", slot_party_defense),#TU 7.20
		   (val_add, ":party_defense", 10),                                         #
		   (val_add, ":hours_takes", ":party_defense"),                             #
...
################## TU ###################
  (
    "construct_siege_chongche",0,
    "As the party member with the highest Engineer skill ({reg2}), {reg3?you estimate:{s3} estimates} that building a chongche will take\
 {reg4} hours.",
    "none",
    [(call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
     (assign, ":max_skill", reg0),
  ...
  (
    "construct_siege_chuan",0,
    "As the party member with the highest Engineer skill ({reg2}), {reg3?you estimate:{s3} estimates} that building a chuan will take\
 {reg4} hours.",
    "none",
    [(call_script, "script_get_max_skill_of_player_party", "skl_engineer"),
     (assign, ":max_skill", reg0),
...
{reg1? You may station troops here to defend it against enemies who may try to recapture it. Also, you should select now whether you will hold the {reg2?town:castle} yourself or give it to a faithful vassal...:}",# Only visible when castle is taken without being a vassal of a kingdom.
    ...
    [
        ...
        (try_begin),
          ...
          (jump_to_menu, "mnu_castle_taken_2"),# TU 7.4
        (else_try),
...
##  ),
  ...
  ##            (lt, ":min_enemy_str", "$g_friend_fit_for_battle"),
    ...
    [
      ...
      "Charge the controller(Controller:{s5}).",
      [
       (assign, "$g_change_controller_num", 4),
       (jump_to_menu, "mnu_encounter_change_controller"),
      ]),
      #add by dark night end    
	  jineng_menu_battle,#TU 6.24
         ...
         (neg|troop_is_wounded, "$g_player_troop"),
          ...
          "Join the battle.",[              
              ...
              (try_begin),
                (party_slot_eq, "$current_town", slot_center_siege_with_belfry, 1),
                (set_jump_mission,"mt_castle_attack_walls_belfry"),
########### gm ###### chongche #### siege_defender_join_battle ###### TU ########
			  (else_try),
				(party_slot_eq, "$current_town", slot_center_siege_with_belfry, 2),
                (set_jump_mission,"mt_castle_attack_walls_chongche"),
##########################################
########### gm ###### chuan ###### siege_defender_join_battle #### TU ##########
			(else_try),
			  (party_slot_eq, "$current_town", slot_center_siege_with_belfry, 3),
              (set_jump_mission,"mt_castle_attack_walls_ship"),
##########################################
              ...
              (jump_to_menu, "mnu_battle_debrief"),
              (change_screen_mission)]),
      ("siege_defender_troops_join_battle",[(neq, "$freelancer_state", 1),#TU jineng_xiaobing
											(call_script, "script_party_count_members_with_full_health", "p_main_party"),
...
######## gm ########### jiaolian ######### TU ###### "village_manage" ##
	  ("change_coach",
		[(neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
		 (party_slot_eq, "$current_town", slot_town_lord, "trp_player")],
		 "Change the coach",
		[(start_presentation, "prsnt_change_coach"),]
	  ),
#####################
...
#################### TU ######### forced_conscription #### gm #
	  ("forced_conscription",
		[
			(party_slot_ge, "$current_town", slot_town_prosperity, 30),
			(neg|party_slot_ge, "$current_town", slot_village_infested_by_bandits, 1),
			(party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
		],
		 "Forced conscription",
		[
           (jump_to_menu, "mnu_forced_conscription"),
		]),
#######################
...
#		(try_end),
		...
		######## TU ##### 7.4 #### jincheng ##
		# (try_begin),
			# (party_get_slot, ":party_state", "$current_town", slot_village_state),
			# (eq, ":party_state", svs_under_siege),
			# (eq, "$leave_flag", 0),
			# (assign, "$leave_flag", 0),
			# # (party_slot_eq, "$current_town", slot_party_type, spt_town),
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             (try_begin),
               ...
               (this_or_next|neg|check_quest_finished, "qst_beat_zhangjiao"),
               (this_or_next|neg|check_quest_finished, "qst_ask_merchant"),
...
#add by dark night
			(try_begin),
			    ...
			    (try_begin),
			    	(eq, "$save_yuji", 0),
							(set_visitor, 32, "trp_yuji"),
							(set_visitor, 33, "trp_knight_5_3"),
					(else_try),
						(eq, "$save_yuji", 2),
							(set_visitor, ":cur_entry", "trp_yuji"),
							(val_add, ":cur_entry", 1),
					(try_end),						
			(try_end), 
#add end			 
...
#####################		
      ...
      [
        (neg|party_slot_eq, "$current_town", slot_village_state, svs_under_siege),
        (faction_slot_eq, "fac_player_supporters_faction", slot_faction_leader, "trp_player"),
        (party_slot_eq, "$current_town", slot_town_lord, "trp_player"), #TU 7.4
        (eq, "$g_encountered_party_faction", "fac_player_supporters_faction"),
      ...
      [	  
		...
		(else_try), #option 2 - town is unassigned and part of the player faction
		  ...
		  (neg|party_slot_ge, "$g_encountered_party", slot_town_lord, active_npcs_begin), #ie, zero or -1 #TU 7.4
...
##          ]),
      ...
      [
		...
		# (try_begin),
			...
			# (eq, ":party_state", svs_under_siege),
			# (eq, "$leave_flag", 0),
			# (store_faction_of_party, ":encountered_faction", "$current_town"),
			# (eq, ":encountered_faction", "$players_kingdom"),
			# # (leave_encounter),
			# (party_get_slot, ":party_no", "$current_town", slot_center_is_besieged_by),
			# (assign, "$g_encountered_party", ":party_no"),
			# (start_encounter, "$g_encountered_party"),
			# (jump_to_menu, "mnu_chucheng"),
		# (else_try),
			(assign, "$g_permitted_to_center",0),
			(change_screen_return,0),
		# (try_end),
  ...
  (
    ...
    [
	  ...
	  (try_for_range, ":walled_center", walled_centers_begin, walled_centers_end),
		...
		# (troop_set_slot, "trp_player", slot_troop_town, ":walled_center"),#TU 7.4
...
############ TU ##### renwu #######
		  ...
		  (neq, "$relative_of_merchant_is_found", 1),
		  (str_store_string, s3, "str_bandit_hideout_preattack_2"),
		(else_try),
#######################################
    ...
    [
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (try_begin),
	        (eq, "$g_starting_town", "p_town_6"), #player selected swadian city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),	    
	      (else_try),
	        (eq, "$g_starting_town", "p_town_8"), #player selected Vaegir city as starting town.
	        (assign, ":scene_to_use", "scn_lair_taiga_bandits"),	    
	      (else_try),
	        (eq, "$g_starting_town", "p_town_10"), #player selected Khergit city as starting town.
	        (assign, ":scene_to_use", "scn_lair_steppe_bandits"),	    
	      (else_try),
	        (eq, "$g_starting_town", "p_town_1"), #player selected Nord city as starting town.
	        (assign, ":scene_to_use", "scn_lair_sea_raiders"),
	      (else_try),
	        (eq, "$g_starting_town", "p_town_5"), #player selected Rhodok city as starting town.
	        (assign, ":scene_to_use", "scn_lair_mountain_bandits"),
	      (else_try),
	        (eq, "$g_starting_town", "p_town_19"), #player selected Sarranid city as starting town.
	        (assign, ":scene_to_use", "scn_lair_desert_bandits"),	    
	      (try_end),  
	    (try_end),
  ...
  ("start_phase_2_5",mnf_disable_all_keys,
    ...
    [
      ...
      ("quick_start",[(eq, "$cheat_mode", 1),], "Quick start...",
       [
		 (change_screen_map),
       ]),
    ]
    ...
    [
	  ...
	  (player_has_item, "itm_velvet"),
       ...
       [         
		...
		# (troop_set_slot, "trp_player", slot_troop_town, "$current_town"),#TU 7.4
 ...
 # ZZ juewei notification  add by TU
(
    "title_notification",0,
    "{s45}^{reg10?Your subordinates:{s30}: }",
    "none",
    [
		(assign, ":num_subordinates", 0),
        (try_for_range, ":troop_no_2", lords_begin, lords_end),                  
			(store_troop_faction, ":troop_faction_2", ":troop_no_2"),
			(assign, ":troop_faction", "$players_kingdom"),
			(is_between, ":troop_faction", kingdoms_begin, kingdoms_end),
			(eq, ":troop_faction_2", ":troop_faction"),
			(troop_get_slot, ":troop_title_2", ":troop_no_2", slot_troop_title_level),
			(troop_get_slot, ":troop_title", "trp_player", slot_troop_title_level),
			(gt, ":troop_title", 40),
			(lt, ":troop_title_2", 80),
			(gt, ":troop_title_2", ":troop_title"),
			(val_sub, ":troop_title_2", ":troop_title"),
			(val_mod, ":troop_title_2", 4),
			(eq, ":troop_title_2", 0),
            (try_begin),
              (eq, ":num_subordinates", 0),
              (str_store_troop_name_link, s30, ":troop_no_2"),
            (else_try),
              (str_store_troop_name_link, s31, ":troop_no_2"),
              (str_store_string, s30, "@{!}{s31}, {s30}"),
            (try_end),
            (val_add, ":num_subordinates", 1),
        (try_end),
		(assign, reg10, ":num_subordinates"),
	],
    [
         ("continue",
         [],
 ...
 (
    "encounter_change_controller",0,
    "Change controller",
    "none",
    [(party_get_num_companion_stacks, "$num_controller","p_main_party"),
     (val_sub,"$num_controller",1),
    ],
    [
         ("change_controller",
         [(ge,"$num_controller",0),
          (party_stack_get_troop_id,":controller_troop","p_main_party",0),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
          (neg|troop_is_wounded, ":controller_troop"),
         ],
         "{s7}(Lv {reg7})",
         [
          (party_stack_get_troop_id,":controller_troop","p_main_party",0),
          (assign, "$g_player_troop", ":controller_troop"),
          (set_player_troop, "$g_player_troop"),
          (try_begin),
            (eq, "$g_change_controller_num", 0),
            (jump_to_menu, "mnu_simple_encounter"),
          (else_try),
            (eq, "$g_change_controller_num", 1),
            (jump_to_menu, "mnu_join_battle"),
          (else_try),
            (eq, "$g_change_controller_num", 2),
            (jump_to_menu, "mnu_besiegers_camp_with_allies"),        
          (else_try),
            (eq, "$g_change_controller_num", 3),
            (jump_to_menu, "mnu_castle_besiege"),    
          (else_try),
            (eq, "$g_change_controller_num", 4),
            (jump_to_menu, "mnu_siege_started_defender"),   
          (try_end),
         ]),
         ...
         ("change_controller",
         [(ge,"$num_controller",1),
          (party_stack_get_troop_id,":controller_troop","p_main_party",1),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
         ...
         ("change_controller",
         [(ge,"$num_controller",2),
          (party_stack_get_troop_id,":controller_troop","p_main_party",2),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
         ...
         ("change_controller",
         [(ge,"$num_controller",3),
          (party_stack_get_troop_id,":controller_troop","p_main_party",3),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
         ...
         ("change_controller",
         [(ge,"$num_controller",4),
          (party_stack_get_troop_id,":controller_troop","p_main_party",4),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
         ...
         ("change_controller",
         [(ge,"$num_controller",5),
          (party_stack_get_troop_id,":controller_troop","p_main_party",5),
          (str_store_troop_name, s7, ":controller_troop"),
          (store_character_level, ":troop_level", ":controller_troop"),
          (assign, reg7, ":troop_level"),
          (troop_is_hero, ":controller_troop"),
...
############ gm ############# suijun ######### TU #############
   ("suijun_loot",mnf_disable_all_keys,
	 "This is the loot",
	 "none",
     [],
	 [
	    ...
	    ("sale_all_loot",[],"Sale all loot",
		[
			(assign,":total",0),
			(troop_get_inventory_capacity, ":capacity", "trp_temp_troop"),
			(try_for_range, ":i_inv", 0, ":capacity"),
				(troop_get_inventory_slot, ":item_id", "trp_temp_troop", ":i_inv"),
				(gt, ":item_id",-1),
				(store_item_value, ":base_price", ":item_id"),
				(troop_get_inventory_slot_modifier, ":imod", "trp_temp_troop", ":i_inv"),
				(call_script, "script_get_mul_of_modifier", ":imod"),
				(val_mul,":base_price",reg0),
				(val_div,":base_price",100),
				(call_script, "script_game_get_item_sell_price_factor", ":item_id"),
				(val_mul, ":base_price", reg0),
				(val_div, ":base_price", 100),

				(val_mul,":base_price",3),
				(val_div,":base_price",4),
				(val_add, ":total",":base_price"),
			(try_end),
			(troop_add_gold, "trp_player", ":total"),
			(jump_to_menu, "mnu_total_victory"),
	    ]),
		("go_back",[],"Go back",[(jump_to_menu, "mnu_total_victory"),]),
	 ]
  ),
...
#################### TU ######### forced_conscription #### gm #
   ("forced_conscription",mnf_disable_all_keys,
	 "Forced conscription",
	 "none",
     [],
	 [
		("continue",[],"Continue",
		 [
		  (assign, "$g_battle_result",0),
		  (rest_for_hours_interactive, 1, 12, 0), #rest while not attackable
		  (assign, "$auto_enter_town", "$current_town"),
		  (assign, "$g_town_visit_after_rest", 1),
		  (assign, "$auto_enter_menu_in_center", "mnu_forced_conscription_end"),
		  (change_screen_return),
		]),
		("go_back",[],"Go back",[(jump_to_menu, "mnu_village"),]),
	 ]
  ),
  
   ("forced_conscription_end",mnf_disable_all_keys,
	 "Forced conscription",
	 "none",
     [
		(call_script, "script_party_count_members_with_full_health","p_main_party"),
        ...
        (assign, ":villagers_party_size", reg0),
		(party_get_slot, ":center_relation", "$current_town", slot_center_player_relation),
		(val_div, ":center_relation",-10),
		(val_mul, ":villagers_party_size", ":center_relation"),
		(try_begin),
			(eq, "$g_battle_result", 0),
			(gt, ":villagers_party_size", ":player_party_size"),
			(jump_to_menu, "mnu_village_start_attack_forced_conscription"),
		(else_try),
			(eq, "$g_battle_result", -1),
			(change_screen_return),
		(else_try),
			(eq, "$g_battle_result", 1),
			(party_get_slot, ":center_relation", "$current_town", slot_town_prosperity),
			(val_sub, ":center_relation", 5),
			(party_set_slot, "$current_town", slot_town_prosperity, ":center_relation"),
		(try_end),
	 ],
	 [
		("follow_me",[],"follow_me",
		 [
			(party_get_slot, ":prosperity", "$current_town", slot_town_prosperity),
			(store_div, ":volunteer_amount", ":prosperity", 10),
			(val_min, ":volunteer_amount", 9),
			(val_mul, ":volunteer_amount", 2),
			(val_add, ":volunteer_amount",20),
			(party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
		...
		# ("give_to_center",[],"Give to center.",
		 # [
			...
			# (val_add, ":volunteer_amount",20),
			# (party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
			# (party_get_slot, ":min_dist_town", "$current_town", slot_village_bound_center),
			# (party_add_members, ":min_dist_town", ":volunteer_troop", ":volunteer_amount"),
			
			# (party_set_slot, "$current_town", slot_center_volunteer_troop_amount, 0),
			# (party_get_slot, ":center_relation", "$current_town", slot_center_player_relation),
			# (val_sub, ":center_relation",10),
			# (party_set_slot, "$current_town", slot_center_player_relation, ":center_relation"),
			# (jump_to_menu, "mnu_village"),
			# (rest_for_hours_interactive, 1, 5, 0), #rest while not attackable
			# (assign, "$auto_enter_town", "$current_town"),
			# (assign, "$g_town_visit_after_rest", 1),
			# (assign, "$auto_enter_menu_in_center", "mnu_village"),
			# (change_screen_return),
	    # ]),
		("continue",[],"Continue",[(jump_to_menu, "mnu_village"),]),
	 ]
  ...
  (
    "village_start_attack_forced_conscription",mnf_disable_all_keys|mnf_scale_picture,
    "Some of the angry villagers grab their tools and prepare to resist you.\
 It looks like you'll have a fight on your hands if you continue.",
    "none",
    [],
    [
      ("village_raid_attack",[],"Charge them.",[
          ...
          (party_get_slot, ":scene_to_use", "$current_town", slot_castle_exterior),
          (jump_to_scene, ":scene_to_use"),
          (assign, "$g_next_menu", "mnu_forced_conscription_end"),
...
################ TU ####### game_menus #########
	("hulaoguan", mnf_disable_all_keys|mnf_scale_picture,
	"hulaoguan",
	"none",
	[
		(try_begin),
			(eq, "$zhanguaxiong", 1),
			(str_store_string, s1, "str_mod1_hulaoguan_menu_2"),
		(else_try),
			(faction_get_slot, ":troop_no", "$players_kingdom",  slot_faction_leader),
			(str_store_troop_name, s0, ":troop_no"),
			(str_store_string, s1, "str_mod1_hulaoguan_menu"),
		(try_end),
	],
	[
		("continue",[(eq, "$zhanguaxiong", 0),],"Continue",
		[
			(set_jump_mission,"mt_hulaoguan_dazhang"),
			(modify_visitors_at_site, "scn_hulaoguan_dazhang"),
			(reset_visitors),
			(set_visitor, 0, "trp_player"),
			(set_visitor, 16, "trp_kingdom_3_lord"),
			(set_visitor, 17, "trp_knight_mod_21"),
			(set_visitor, 18, "trp_kingdom_1_lord"),
			# (set_visitor, 19, "trp_kingdom_5_lord"),
			(set_visitor, 20, "trp_knight_mod_1"),
			(set_visitor, 21, "trp_knight_mod_2"),
			(set_visitor, 22, "trp_knight_mod_4"),
			(set_visitor, 23, "trp_knight_mod_20"),
			(set_visitor, 24, "trp_kingdom_2_lord"),
			(set_visitor, 25, "trp_knight_2_1"),
			(set_visitor, 26, "trp_knight_2_2"),
			
			(set_visitor, 27, "trp_khergit_horseman"),
			
			(set_visitor, 28, "trp_knight_mod_28"),
			(set_visitor, 29, "trp_knight_mod_29"),
			(set_visitor, 30, "trp_knight_mod_30"),
			# (set_visitor, 0, "$wy_duelist_troop_id"),
			(jump_to_scene,"scn_hulaoguan_dazhang"),
			(change_screen_mission),
		]),
		
		("hulaoguan_leave",[(eq, "$zhanguaxiong", 1),],"Leave...",[(change_screen_map)]),
	]),
###########################

######### TU ####
      ("troops_prepare",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        "Troops prepare",
        "none",
        [],
        [
            ("separate_army", [],
             "Separate army.",
             [
                 (start_presentation, "prsnt_separate_army"),
             ]
            ),
            ("merger_army", [],
             "Merger armies",
             [
                 (start_presentation, "prsnt_merger_army"),
             ]
            ),
            ("go_back", [],
             "Go back.",
...
############### TU ###### suijishijian #### 7.11 ###
      ("suijishijian_qiangdao",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        "When you leave the army ready to use the bathroom, you see a group of the robber is preparing to rob a few passing farmers. You decide to",
        "none",
        [],
        [
            ("help_these_farmers", [],
             "Help these farmers.",
             [
				(modify_visitors_at_site,"scn_suijishijian_qiangdao"),
				(reset_visitors),
				
				(set_visitors, 0, "trp_player"),
				(set_visitors, 1, "trp_farmer", 5),
				(set_visitors, 2, "trp_bandit", 10),                   

				(set_jump_mission,"mt_suijishijian_qiangdao"),
				(jump_to_scene,"scn_suijishijian_qiangdao"),
				(jump_to_menu, "mnu_suijishijian_qiangdao_2"),
				(change_screen_mission),
             ]
            ),
            ("suiji_leave", [],
      ...
      ("suijishijian_qiangdao_2",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        "{s0}",
        "none",
        [
		(try_begin),
			(eq, "$g_battle_won", 1),
			(store_random_in_range, ":random_num", weapons_begin, shields_end),
			(troop_add_item, "trp_player", ":random_num", imod_well_made),
			(str_store_item_name_by_count, s1, ":random_num"),
			(str_store_string, s0, "str_suijishijian_qiangdao_win"),
		(else_try),
			(str_store_string, s0, "str_suijishijian_qiangdao_fail"),
		(try_end),
		],
        [
            ("leave", [],
      ...
      ("suijishijian_cike",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        "Somebody have to kill you",
        "none",
        [],
        [
            ("come_on", [],
             "continue",
             [
				(modify_visitors_at_site,"scn_suijishijian_cike"),
				(reset_visitors),
				
				(set_visitors, 0, "trp_player"),
				(set_visitors, 1, "trp_swadian_infantry_multiplayer_ai", 1),             

				(set_jump_mission,"mt_suijishijian_cike"),
				(jump_to_scene,"scn_suijishijian_cike"),
				(jump_to_menu, "mnu_suijishijian_cike_2"),
				(change_screen_mission),
             ]
            ),           
        ]),
		
      ("suijishijian_cike_2",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        "{s0}",
        "none",
        [
		(try_begin),
			(eq, "$g_battle_won", 1),
			(str_store_string, s0, "str_suijishijian_cike_win"),
		(else_try),
			(assign, ":end_num", 9),
			(try_for_range, reg0, 0, ":end_num"),
				(store_random_in_range, ":random_num", ek_item_0, ek_food),
				(troop_get_inventory_slot, ":item_id", "trp_player", ":random_num"),
				(gt, ":item_id", -1),
				(str_store_item_name_by_count, s1, ":item_id"),
				(troop_remove_item, "trp_player", ":item_id"),
				(str_store_string, s0, "str_suijishijian_cike_fail"),
				(assign, ":end_num", 0),
			(try_end),
		(try_end),
		],
...
########### jineng ####
      ("jineng_menu",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        " ",
        "none",
        [],
        [
            ("meirenji", [
				...
				(try_for_range, ":cur_stack", 0, ":num_stacks"),
					...
					(troop_get_slot, ":jineng_no", ":cur_troop", slot_troop_jineng),
					(troop_get_slot, ":jinengdian", ":cur_troop", slot_troop_jinengdian),
					(troop_get_slot, ":jineng_flag", ":cur_troop", slot_troop_jineng_flag),
					(eq, ":jineng_no", meirenji),
					(ge, ":jinengdian", 7),
					(eq, ":jineng_flag", 0),
					(assign, ":num_stacks", 0),
					(assign, ":continue", 1),
					(assign, "$meirenji_troop", ":cur_troop"),
				(try_end),
				(eq, ":continue", 1),
			],
             "meirenji",
             [
                 (start_map_conversation, "trp_meiren", -1),
				 (change_screen_map),
             ]
            ),   
			...
			("kongchengji", [
             ...
             "kongchengji",
             [
                 (start_map_conversation, "trp_shutong", -1),
				 (change_screen_map),
             ]
            ), 
      ...
      ("jineng_menu_battle",menu_text_color(0xFF000000)|mnf_disable_all_keys,
        " ",
        "none",
        [],
        [
            ("wuzhongshengyou", [
             ...
             [
				...
				(assign, "$wuzhongparty_friend", reg(0)),
				(party_get_num_companion_stacks, ":num_stacks", "p_main_party"),
				(try_for_range, ":cur_stack", 0, ":num_stacks"),
					(party_stack_get_troop_id, ":cur_troop", "p_main_party", ":cur_stack"),
					(neg|troop_is_hero, ":cur_troop"),
					(party_stack_get_size, ":troop_num", "p_main_party", ":cur_stack"),
					(val_div, ":troop_num", 5),
					(party_add_members, "$wuzhongparty_friend", ":cur_troop", ":troop_num"),
				(try_end),
				(party_quick_attach_to_current_battle, "$wuzhongparty_friend", 0),
				(str_store_party_name, s1, "p_main_party"),
				(display_message, "str_s1_joined_battle_friend"),
		# ######## TU #### 6.24 #### jineng #######
		# (try_begin),
			# (ge, "$wuzhongparty_friend", 0),
			# (remove_party, "$wuzhongparty_friend"),
			# (assign, "$wuzhongparty_friend", -1),
		# (try_end),
		# ###############
             ]
            ),
    ...
    [
	 ...
	 (troop_get_slot, "$teacher_party", "$teacher_lord", slot_troop_leaded_party), #CABA - to refresh it? maybe not necessessary
	],
	[
		("join_commander_battle",[
			(party_get_battle_opponent, ":commander_opponent", "$teacher_party"),
			...
			# (try_begin),
				...
				# (set_show_messages, 1),
			# (try_end),
			(start_encounter, "$teacher_party"),
			(change_screen_map),
		]),
		
        ("enter_town",[(party_is_in_any_town,"$teacher_party"),] ,"Enter stationed town.",
        [(party_get_cur_town, ":town_no", "$teacher_party"),(start_encounter, ":town_no"),(change_screen_map),]),
	 
		("commander",[(party_get_battle_opponent, ":commander_opponent", "$teacher_party"),(lt, ":commander_opponent", 0),],
        ...
        [(change_screen_map),
		(assign, "$g_infinite_camping", 1),
        (rest_for_hours_interactive, 24 * 365, "$speed_of_wait", 1),
		]),
	]),
...
#menu_aud_with_commander 
  (
    ...
    [#(set_background_mesh, "mesh_pic_soldier_world_map"),
		(try_begin),
			(gt, "$teacher_lord", 0),
			(str_store_troop_name, s6, "$teacher_lord"),
		(else_try),
			(change_screen_map),
		(try_end),
	],
  ...
  (
    "learn_success",0,
    "Your have learn your teacher,s jineng {s2}. ",
    "none",
    [
		(troop_get_slot, ":jineng", "$teacher_lord", slot_troop_jineng),
		# (try_begin),
			# (eq, ":jineng", meirenji),
			# (assign, ":jineng", "str_meirenji"),
		# (else_try),
			(val_add, ":jineng", "str_weishe"),
			(val_sub, ":jineng", 1),
		# (try_end),
		(str_store_string, s2, ":jineng"),
	],
    [
      ("continue",[],
       "Continue...",
...
######## TU ##### 7.4 #### jincheng ##  
  # (
    ...
    # [
      # ("continue",[],
       # "Continue...",
       # [
			# (party_get_slot, ":party_no", "$g_encountered_party", slot_center_is_besieged_by),
			# # (start_encounter, ":party_no"),(change_screen_map),
				# # (set_encountered_party, ":party_no"),
				# # (call_script, "script_game_event_party_encounter", ":party_no", -100000),
			# (assign, "$g_encountered_party", ":party_no"),
			# (set_encountered_party, ":party_no"),
			...
			# (jump_to_menu, "mnu_jincheng_encounter"),
  ...
  # ("jincheng_encounter",mnf_enable_hot_keys|mnf_scale_picture,
	# "{s2} You have {reg10} troops fit for battle.",
    # "none",
    # [
        # (assign, "$g_enemy_party", "$g_encountered_party"),
        # (assign, "$g_ally_party", -1),
        ...
        # (else_try), #second or more turn
			# (eq, "$leave_flag", 1),
			# # (assign, "$current_town", "$g_jincheng_castle"),
			# # (change_screen_return,0),
			# # (set_encountered_party, "$g_jincheng_castle"),
			# # (jump_to_menu,"mnu_town"),
			# (start_encounter, "$g_jincheng_castle"),(change_screen_map),
        # (try_end),
    ...
    # [ 
      ...
      # [
		...
		# (set_jump_mission,"mt_lead_charge_jincheng"),
		# (call_script, "script_setup_random_scene"),

        # (assign, "$g_next_menu", "mnu_jincheng_encounter"),
		# (jump_to_menu, "mnu_battle_debrief"),
        # (change_screen_mission),
      # ]),
...
# #Troop commentary changes end
    ...
    # [
      # ("continue",[],
       ...
       # [
			...
			# (jump_to_menu, "mnu_chucheng_encounter"),
  ...
  # ("chucheng_encounter",mnf_enable_hot_keys|mnf_scale_picture,
	# "{s2} You have {reg10} troops fit for battle against their {reg11}.",
    # "none",
    # [
        # (assign, "$g_enemy_party", "$g_encountered_party"),
        ...
        # (else_try), #second or more turn
			...
			# # (set_encountered_party, "$g_jincheng_castle"),
			# # (jump_to_menu,"mnu_town"),
			# # (start_encounter, "$g_jincheng_castle"),
			# (assign, "$leave_flag", 0),
			# (leave_encounter),(change_screen_return),
			# # (change_screen_map),
        # (try_end),
    ...
    # [ 
      ...
      # ("encounter_leave",[
          # (eq,"$cant_leave_encounter", 0),
          # ],"Leave.",[
			# (assign, ":party_no", "$g_jincheng_castle"),
			# (assign, "$g_encountered_party", ":party_no"),
			# (set_encountered_party, ":party_no"),
			# (assign, "$leave_flag", 1),
			# (call_script, "script_game_event_party_encounter", ":party_no", -100000),
          ...
          (try_for_range, ":stack_no", "$last_defeated_hero", ":num_stacks"), #May 31 bug note -- this now returns some heroes in victorious party as well as in the other party
			...
			(else_try),
			  ...
			  (try_begin),
				...
				(troop_get_slot, ":rand", ":stack_troop", slot_troop_fuluwujiang),## TU ##### 2014.1.11 ## fuluwujiang ##
...
############ cheng_duel ####### gm ###### TU ######
   ("cheng_duel",mnf_disable_all_keys,
    "{s1}",
    "none",
    [
		(assign, ":have_horse", 0),
		...
		(party_get_num_companion_stacks, ":num_stacks", "p_collective_enemy"),
		(try_for_range, ":cur_stack", 0, ":num_stacks"),
			(party_stack_get_troop_id, ":cur_troop", "p_collective_enemy", ":cur_stack"),
			(troop_is_hero,":cur_troop"),
			(troop_get_slot,":title_level", ":cur_troop", slot_troop_title_level),
			(try_begin),
				(troop_slot_eq, ":cur_troop", slot_troop_is_king, -1),
			...
			(assign, "$team_1_head_troop", ":cur_troop"),
		(try_end),
		(try_begin),
			(eq, ":have_horse", 1),
			(call_script, "script_wy_duel_or_not_troop_and_troop", "$team_1_head_troop"),
		(else_try),
			(assign, "$wy_duel_able",0),
		(try_end),
		(try_begin),
			(eq, "$wy_duel_able",0),
			(str_store_string, s1, "str_refuse_duel"),
		(else_try),
			(eq, "$wy_duel_able",1),
			(assign, ":max_str",-1),
			(party_get_num_companion_stacks, ":num_stacks", "p_collective_enemy"),
			(try_for_range, ":cur_stack", 0, ":num_stacks"),
				(party_stack_get_troop_id, ":cur_troop", "p_collective_enemy", ":cur_stack"),
				(troop_is_hero,":cur_troop"),
				(store_attribute_level,":att_1",":cur_troop",0),   
				(store_attribute_level,":att_2",":cur_troop",1),
				(val_add, ":att_1", ":att_2"),

				(gt,":att_1",":max_str"),
				(assign, ":max_str", ":att_1"),
				(assign, "$wy_duelist_troop_id", ":cur_troop"), 
			(try_end),
			(str_store_troop_name, s2, "$wy_duelist_troop_id"),
			(str_store_string, s1, "str_accept_duel_s2"),
		(try_end),
	],
    [
      ("continue",[],"Continue...",
       [
		...
		(else_try),
			(eq, "$wy_duel_able",1),
			(assign, ":battle_scene", "scn_town_6_walls"),
			(set_jump_mission,"mt_castle_duel"),
			
			(store_faction_of_party, "$g_encountered_party_faction", "$g_encountered_party"),
			(store_relation, ":party_relation", "$g_encountered_party_faction", "fac_player_faction"),
			(try_begin),
				(gt,":party_relation",0),
				(jump_to_menu, "mnu_siege_started_defender"),
				(modify_visitors_at_site, ":battle_scene"),
				(reset_visitors),
				(set_visitor, 1, "trp_player"),
				(set_visitor, 0, "$wy_duelist_troop_id"),
				(assign,"$gongfang",0),
			(else_try),
				...
				(reset_visitors),
				(set_visitor, 0, "trp_player"),
				(set_visitor, 1, "$wy_duelist_troop_id"),
				(assign, "$gongfang", 1),
			(try_end),
